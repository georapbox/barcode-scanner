...
return import(a("kyEFX").resolve(t))}});let r=(t="",e="")=>{let i=Math.random().toString(36).substring(2,8);return`${"string"==typeof t&&""!==t?t+"-":""}${i}${"string"==typeof e&&""!==e?"-"+e:""}`},l=(t,e)=>{if(Object.prototype.hasOwnProperty.call(e,t)){let i=e[t];delete e[t],e[t]=i}},d=0,c=`
  :host {
...
t.oncomplete=t.onsuccess=function(){return e(t.result)},t.onabort=t.onerror=function(){return i(t.error)}})}function tm(){if(!e){var t,i,o;t="keyval",(i=indexedDB.open("keyval-store")).onupgradeneeded=function(){return i.result.createObjectStore(t)},o=tb(i),e=function(e,i){return o.then(function(o){return i(o.transaction(t,e).objectStore(t))})}}return e}const tg="barcode-scanner/",tf="settings",tv="history",tw=async t=>{try{return{value:await /**
 ...
 */class tO extends tN{constructor(){super();let t=this.shadowRoot.querySelector('slot[name="copy"]'),e=this.shadowRoot.querySelector('slot[name="success"]');t.innerHTML=/* html */`
...
||t.loading||n.querySelector(".results__item")||$(),null!=t&&"function"==typeof t.startVideoStream&&t.startVideoStream()}"fileTab"===e&&(A=!1,null!=s&&"function"==typeof s.stopVideoStream&&s.stopVideoStream())},250)),c.addEventListener("files-dropzone-drop",t=>{!function(t){if(!t)return;let i=new Image,o=new FileReader;o.onload=o=>{let s=o.target.result;i.onload=async()=>{try{let t=await D(i);q(r),I(t.rawValue,r),_(t.rawValue),T(200,860,.03,"square"),N()}catch(t){q(r),I(e,r)}},i.src=s,c.replaceChildren();let a=document.createElement("div");a.className="dropzone-preview";let n=document.createElement("div");n.className="dropzone-preview__image-wrapper";let l=document.createElement("div");l.className="dropzone-preview__file-name",l.textContent=t.name,n.appendChild(i),a.appendChild(n),a.appendChild(l),c.prepend(a)},o.readAsDataURL(t)}(t.detail.acceptedFiles[0])}),h.addEventListener("resize-observer:resize",()=>{O(s.shadowRoot.querySelector("video"))}),v.addEventListener("click",()=>{w.showModal()}),b.addEventListener("click",()=>{m.showModal()}),m.addEventListener("click",t=>{t.target===t.currentTarget&&m.close()}),w.addEventListener("click",t=>{t.target===t.currentTarget&&w.close()}),y.addEventListener("change",t=>{let e={},i=t.currentTarget.querySelectorAll('input[type="checkbox"]');i.forEach(t=>e[t.name]=t.checked),tA(e)}),g.addEventListener("click",t=>{let e=t.target;e.closest('[data-action="delete"]')&&window.confirm("Delete item from history?")&&R(e.closest("li").dataset.value)}),f.addEventListener("click",()=>{window.confirm("Are you sure you want to empty history?")&&M()})}();//# sourceMappingURL=index.1f8e1820.js.map

//# sourceMappingURL=index.1f8e1820.js.map
