var t,e,i,s="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},o={},a={},n=s.parcelRequirea202;null==n&&((n=function(t){if(t in o)return o[t].exports;if(t in a){var e=a[t];delete a[t];var i={id:t,exports:{}};return o[t]=i,e.call(i.exports,i,i.exports),i.exports}var s=Error("Cannot find module '"+t+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(t,e){a[t]=e},s.parcelRequirea202=n);var r=n.register;r("1OZCQ",function(t,e){var i=n("hffE7");t.exports=i("5JYMk").then(()=>n("aexh3"))}),r("hffE7",function(t,e){t.exports=function(t){// eslint-disable-next-line no-undef
return import(n("kyEFX").resolve(t))}});const l="a-tab",d=document.createElement("template");let c=0;d.innerHTML=/* html */`
  <style>
    .tab {
      display: inline-flex;
      align-items: center;
...
`;class z extends HTMLElement{#i=!1;#s;static get observedAttributes(){return["placement","no-scroll-controls"]}constructor(){super(),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(x.content.cloneNode(!0)))}connectedCallback(){this.#t("placement"),this.#t("noScrollControls"),this.#t("scrollDistance"),this.#t("activation"),this.#t("panelTransition");let t=this.shadowRoot.querySelector("slot[name=tab]"),e=this.shadowRoot.querySelector("slot[name=panel]"),i=this.shadowRoot.querySelector(".tab-group__tabs"),s=this.shadowRoot.querySelector(".tab-group__nav"),o=Array.from(this.shadowRoot.querySelectorAll(".tab-group__scroll-button"));t.addEventListener("slotchange",this.#o),e.addEventListener("slotchange",this.#o),i.addEventListener("click",this.#a),i.addEventListener("keydown",this.#n),o.forEach(t=>t.addEventListener("click",this.#r)),this.addEventListener(`${v}-close`,this.#l),"ResizeObserver"in window&&(this.#s=new ResizeObserver(t=>{let e=t?.[0],i=e?.target,a=i?.scrollWidth>(e?.borderBoxSize?.[0]?.inlineSize||i?.clientWidth);o.forEach(t=>t.hidden=!a),s.classList.toggle("tab-group__nav--scrollable",a)})),this.#d(),this.hidden=0===this.#c().length,this.placement=this.placement||"top"}disconnectedCallback(){let t=this.shadowRoot.querySelector("slot[name=tab]"),e=this.shadowRoot.querySelector("slot[name=panel]"),i=this.shadowRoot.querySelector(".tab-group__tabs"),s=Array.from(this.shadowRoot.querySelectorAll(".tab-group__scroll-button"));t.removeEventListener("slotchange",this.#o),e.removeEventListener("slotchange",this.#o),i.removeEventListener("click",this.#a),i.removeEventListener("keydown",this.#n),s.forEach(t=>t.removeEventListener("click",this.#r)),this.removeEventListener(`${v}-close`,this.#l),this.#h()}attributeChangedCallback(t,e,i){"placement"===t&&e!==i&&this.#d(),"no-scroll-controls"===t&&e!==i&&this.#d()}get placement(){return this.getAttribute("placement")}set placement(t){this.setAttribute("placement",t)}get noScrollControls(){return this.hasAttribute("no-scroll-controls")}set noScrollControls(t){t?this.setAttribute("no-scroll-controls",""):this.removeAttribute("no-scroll-controls")}get scrollDistance(){return Math.abs(this.getAttribute("scroll-distance"))||200}set scrollDistance(t){this.setAttribute("scroll-distance",Math.abs(t)||200)}get activation(){return this.getAttribute("activation")||E}set activation(t){this.setAttribute("activation",t||E)}get panelTransition(){return this.hasAttribute("panel-transition")}set panelTransition(t){t?this.setAttribute("panel-transition",""):this.removeAttribute("panel-transition")}#u(){if(!this.#s)return;let t=this.shadowRoot.querySelector(".tab-group__tabs");this.#s.unobserve(t),this.#s.observe(t)}#h(){this.#s&&this.#s.disconnect()}#p(){let t=this.#c();// Hide the tab group if there are no tabs.
this.hidden=0===t.length,t.forEach(t=>{let e=t.nextElementSibling;if(!e||e.tagName.toLowerCase()!==f)return console.error(`Tab #${t.id} is not a sibling of a <a-tab-panel>`);t.setAttribute("aria-controls",e.id),e.setAttribute("aria-labelledby",t.id)});// Get the selected non-disabled tab, or the first non-disabled tab.
let e=t.find(t=>t.selected&&!t.disabled)||t.find(t=>!t.disabled);this.#b(e)}#m(){return Array.from(this.querySelectorAll(f))}#c(){return Array.from(this.querySelectorAll(v))}#g(t){let e=t.getAttribute("aria-controls");return this.querySelector(`#${e}`)}#v(){return this.#c().find(t=>!t.disabled)}#f(){let t=this.#c();for(let e=t.length-1;e>=0;e--)if(!t[e].disabled)return t[e]}#w(){let t=this.#c(),e=this.activation===A?t.findIndex(t=>t.matches(":focus"))-1:t.findIndex(t=>t.selected)-1;// Keep looping until we find a non-disabled tab.
 ...
 */function(t,e){var i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:t9();return i("readwrite",function(i){return i.put(e,t),t4(i.transaction)})}(t,e),{error:void 0}}catch(t){return{error:t}}},ea=async()=>es(et+ee),en=async t=>eo(et+ee,t),er=async()=>es(et+ei),el=async t=>eo(et+ei,t),ed=document.getElementById("toastContainer"),ec=t=>{let e=t.currentTarget;e.removeEventListener("click",ec),ed.removeChild(e.parentNode)},eh=(t="",e="info")=>{["info","warning","danger"].includes(e)||(e="info");let i=/* html */`
  ...
  `,s=document.createElement("div");s.className=`alert alert-${e} alert-dismissible text-break`,s.innerHTML=i,s.querySelector("button").addEventListener("click",ec),ed.appendChild(s),setTimeout(()=>s.classList.add("show"),100)};let eu="clipboard-copy",ep="success",eb="error",em=document.createElement("template");em.innerHTML=`
  <style>
    :host([hidden]),
    [hidden],
    ::slotted([hidden]) {
 ...
 */class ev extends eg{constructor(){super();let t=this.shadowRoot.querySelector('slot[name="copy"]'),e=this.shadowRoot.querySelector('slot[name="success"]');t.innerHTML=/* html */`
   ...
   */#k(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="custom-clipboard-copy"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,ev)}}ev.defineCustomElement(),async function(){let t;let e="No barcode detected",i=document.querySelector("a-tab-group"),s=document.getElementById("cameraPanel"),o=document.querySelector("capture-photo"),a=document.getElementById("cameraResults"),r=document.getElementById("fileResults"),l=document.getElementById("scanInstructions"),d=document.getElementById("scanBtn"),c=document.getElementById("dropzone"),h=document.querySelector("resize-observer"),u=document.getElementById("scanFrame"),p=document.getElementById("globalActions"),b=document.getElementById("historyBtn"),m=document.getElementById("historyDialog"),g=document.getElementById("historyList"),v=document.getElementById("deleteHistoryBtn"),f=document.getElementById("settingsBtn"),w=document.getElementById("settingsDialog"),y=document.forms["settings-form"],E=document.getElementById("supportedFormats"),A=!0;if(!("BarcodeDetector"in window))try{await n("1OZCQ")}catch(t){return p.hidden=!0,i.style.display="none",eh("BarcodeDetector API is not supported by your browser.","danger")}ta()||document.querySelectorAll("web-share").forEach(t=>{t.hidden=!0,t.disabled=!0});let{value:k=[]}=await er();T(k),o.addEventListener("capture-photo:video-play",t=>{u.hidden=!1,O(t.detail.video),B();let e=o.getTrackSettings(),i=o.getTrackCapabilities(),s=document.getElementById("zoomLevel");if(e?.zoom&&i?.zoom){let t=document.getElementById("zoomControls"),a=i?.zoom?.min||0,n=i?.zoom?.max||10,r=e?.zoom||1;t.hidden=!1,s.textContent=r,t.addEventListener("click",t=>{let e=t.target.closest('[data-action="zoom-in"]'),i=t.target.closest('[data-action="zoom-out"]');e&&r<n&&(r+=.5),i&&r>a&&(r-=.5),s.textContent=r,o.zoom=r})}},{once:!0}),o.addEventListener("capture-photo:error",t=>{let e=t.detail.error;if("NotFoundError"===e.name)return;let i="NotAllowedError"===e.name?"Permission to use webcam was denied or video Autoplay is disabled. Reload the page to give appropriate permissions to webcam.":e.message;s.innerHTML=/* html */`<div class="alert alert-danger" role="alert">${i}</div>`},{once:!0}),t5.defineCustomElement(),c.accept="image/jpg,image/jpeg,image/png,image/apng,image/gif,image/webp,image/avif";let x=o.shadowRoot.querySelector("video"),z=await window.BarcodeDetector.getSupportedFormats(),C=new window.BarcodeDetector({formats:z}),{value:S={}}=await ea();Object.entries(S).forEach(([t,e])=>{let i=y.querySelector(`[name="${t}"]`);i&&(i.checked=e)}),Array.isArray(z)&&z.length>0&&(E.textContent=`Supported formats: ${z.join(", ")}`);let L=(()=>{let t=new(window.AudioContext||window.webkitAudioContext||window.audioContext);if(t)return async(e,i,s,o,a)=>{let{value:n}=await ea();if(!n?.beep)return;let r=t.createOscillator(),l=t.createGain();r.connect(l),l.connect(t.destination),s&&(l.gain.value=s),i&&(r.frequency.value=i),o&&(r.type=o),"function"==typeof a&&(r.onended=a),r.start(t.currentTime),r.stop(t.currentTime+(e||500)/1e3)}})();function T(t){g.innerHTML="",Array.isArray(t)&&t.length?(v.style.display="block",t.forEach(t=>{let e;let i=document.createElement("li");i.setAttribute("data-value",t);try{new URL(t),(e=document.createElement("a")).href=t,e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")}catch(t){e=document.createElement("span")}e.textContent=t,e.setAttribute("title",t);let s=document.createElement("div");s.className="history-modal__actions";let o=document.createElement("custom-clipboard-copy");o.title="Copy to clipboard",o.setAttribute("only-icon",""),o.setAttribute("value",t),s.appendChild(o);let a=document.createElement("button");a.type="button",a.className="history-modal__delete-action",a.title="Remove from history",a.setAttribute("data-action","delete"),a.innerHTML=/* html */`
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
            <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"/>
          </svg>
        `,s.appendChild(a),i.appendChild(e),i.appendChild(s),g.appendChild(i)})):(g.innerHTML="<li class=>There are no saved items in history.</li>",v.style.display="none")}async function _(t){let{value:e}=await ea();if(!t||!e?.addToHistory)return;let{value:i=[],error:s}=await er();if(!s&&!i.find(e=>e===t)){let e=[...i,t],{error:s}=await el(e);s||T(e)}}async function M(t){if(!t)return;let{value:e=[],error:i}=await er();if(!i){let i=e.filter(e=>e!==t),{error:s}=await el(i);s||T(i)}}async function R(){let{error:t}=await el([]);t||T([])}async function N(t=100){let{value:e}=await ea();if("function"==typeof window.navigator.vibrate&&e?.vibrate)try{window.navigator.vibrate(t)}catch{// Fail silently...
}}function O(t){if(!t)return;let e=t.getBoundingClientRect();u.style.cssText=`width: ${e.width}px; height: ${e.height}px`}function q(t){t?.querySelector(".results__item")?.remove()}async function I(t,i){let s;if(!t||!i)return;q(i);try{let{value:e}=await ea();new URL(t),(s=document.createElement("a")).href=t,e?.openWebPageSameTab||(s.setAttribute("target","_blank"),s.setAttribute("rel","noreferrer noopener")),e?.openWebPage&&s.click()}catch(t){s=document.createElement("span")}s.className="results__item",s.classList.toggle("results__item--no-barcode",t===e),s.textContent=t,i.insertBefore(s,i.querySelector(".results__actions"));let o=i.querySelector("custom-clipboard-copy"),a=i.querySelector("web-share"),n=t!==e;o&&(o.disabled=!n,o.hidden=!n),a&&ta()&&(a.disabled=!n,a.hidden=!n,n?a.setAttribute("share-text",t):a.removeAttribute("share-text")),i.show()}function D(t){return new Promise((e,i)=>{C.detect(t).then(t=>{Array.isArray(t)&&t.length>0?e(t[0]):i({message:"Could not detect barcode from provided source."})}).catch(t=>{i(t)})})}async function B(){l.hidden=!1;try{let e={};e=await D(x),window.cancelAnimationFrame(t),q(a),I(e.rawValue,a),_(e.rawValue),l.hidden=!0,d.hidden=!1,u.hidden=!0,L(200,860,.03,"square"),N();return}catch(t){// Fail silently...
}A&&(t=window.requestAnimationFrame(()=>B()))}d.addEventListener("click",()=>{d.hidden=!0,u.hidden=!1,q(a),a.close(),B()}),i.addEventListener("a-tab-select",t=>{let e=t.detail.tabId;"cameraTab"!==e||(A=!0,!o// Assumes that element exists; it might not be the case if the user is using a browser that does not support the BarcodeDetector API.
||o.loading||a.querySelector(".results__item")||B()),"fileTab"===e&&(A=!1)}),c.addEventListener("files-dropzone-drop",t=>{!function(t){if(!t)return;let i=new Image,s=new FileReader;s.onload=s=>{let o=s.target.result;i.onload=async()=>{try{let t=await D(i);q(r),I(t.rawValue,r),_(t.rawValue),L(200,860,.03,"square"),N()}catch(t){q(r),I(e,r)}},i.src=o,c.replaceChildren();let a=document.createElement("div");a.className="dropzone-preview";let n=document.createElement("div");n.className="dropzone-preview__image-wrapper";let l=document.createElement("div");l.className="dropzone-preview__file-name",l.textContent=t.name,n.appendChild(i),a.appendChild(n),a.appendChild(l),c.prepend(a)},s.readAsDataURL(t)}(t.detail.acceptedFiles[0])}),h.addEventListener("resize-observer:resize",()=>{O(o.shadowRoot.querySelector("video"))}),f.addEventListener("click",()=>{w.showModal()}),b.addEventListener("click",()=>{m.showModal()}),m.addEventListener("click",t=>{t.target===t.currentTarget&&m.close()}),w.addEventListener("click",t=>{t.target===t.currentTarget&&w.close()}),y.addEventListener("change",t=>{let e={},i=t.currentTarget.querySelectorAll('input[type="checkbox"]');i.forEach(t=>e[t.name]=t.checked),en(e)}),g.addEventListener("click",t=>{let e=t.target;e.closest('[data-action="delete"]')&&window.confirm("Delete item from history?")&&M(e.closest("li").dataset.value)}),v.addEventListener("click",()=>{window.confirm("Are you sure you want to empty history?")&&R()})}();//# sourceMappingURL=index.b48009fa.js.map

//# sourceMappingURL=index.b48009fa.js.map
