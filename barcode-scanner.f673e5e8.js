...
`,(class t extends HTMLElement{static CLOSE_REQUEST_REASONS={CLOSE_BUTTON:"close-button",ESCAPE_KEY:"escape-key",BACKDROP_CLICK:"backdrop-click",EXTERNAL_INVOKER:"external-invoker"};#t=null;#s=null;#i=null;#r=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(H.content.cloneNode(!0)),this.shadowRoot&&(this.#t=this.shadowRoot.querySelector("dialog"),this.#s=this.shadowRoot.querySelector('slot[name="footer"]'),this.#i=this.shadowRoot.querySelector('slot[name="close"]'))}static get observedAttributes(){return["open","no-header","no-animations","no-close-button","close-label"]}attributeChangedCallback(t,e,o){if(null!==this.#t){if("open"===t&&e!==o&&(this.open?(this.#t.classList.toggle("dialog--no-animations",this.noAnimations),this.#t.showModal(),this.dispatchEvent(new CustomEvent("me-open",{bubbles:!0,composed:!0,detail:{element:this}})),document.body&&!this.preserveOverflow&&(document.body.style.overflow="hidden")):this.#t.close()),"no-header"===t&&e!==o){let t=this.#t.querySelector(".dialog__header");null!==t&&(t.hidden=this.noHeader)}if("no-animations"===t&&e!==o&&this.#t.classList.toggle("dialog--no-animations",this.noAnimations),"no-close-button"===t&&e!==o){let t=this.#t.querySelector(".dialog__close");null!==t&&(t.hidden=this.noCloseButton)}"close-label"===t&&e!==o&&this.#E()}}connectedCallback(){this.#p("open"),this.#p("staticBackdrop"),this.#p("noHeader"),this.#p("noAnimations"),this.#p("noCloseButton"),this.#p("fullscreen"),this.#p("preserveOverflow"),this.#p("placement"),this.#p("closeLabel"),this.#t?.addEventListener("click",this.#c),this.#t?.addEventListener("close",this.#o),this.#t?.addEventListener("cancel",this.#m),this.#t?.querySelector('form[method="dialog"]')?.addEventListener("submit",this.#h),this.#s?.addEventListener("slotchange",this.#a),this.#i?.addEventListener("slotchange",this.#x),this.addEventListener("command",this.#d)}disconnectedCallback(){this.#t?.removeEventListener("click",this.#c),this.#t?.removeEventListener("close",this.#o),this.#t?.removeEventListener("cancel",this.#m),this.#t?.querySelector('form[method="dialog"]')?.removeEventListener("submit",this.#h),this.#s?.removeEventListener("slotchange",this.#a),this.#i?.removeEventListener("slotchange",this.#x),this.removeEventListener("command",this.#d),this.#r&&(this.#r?.cancel(),this.#r=null)}get open(){return this.hasAttribute("open")}set open(t){this.toggleAttribute("open",!!t)}get staticBackdrop(){return this.hasAttribute("static-backdrop")}set staticBackdrop(t){this.toggleAttribute("static-backdrop",!!t)}get noHeader(){return this.hasAttribute("no-header")}set noHeader(t){this.toggleAttribute("no-header",!!t)}get noAnimations(){return this.hasAttribute("no-animations")}set noAnimations(t){this.toggleAttribute("no-animations",!!t)}get noCloseButton(){return this.hasAttribute("no-close-button")}set noCloseButton(t){this.toggleAttribute("no-close-button",!!t)}get fullscreen(){return this.hasAttribute("fullscreen")}set fullscreen(t){this.toggleAttribute("fullscreen",!!t)}get preserveOverflow(){return this.hasAttribute("preserve-overflow")}set preserveOverflow(t){this.toggleAttribute("preserve-overflow",!!t)}get placement(){return this.getAttribute("placement")||"center"}set placement(t){this.setAttribute("placement",null!=t?t.toString():t)}get closeLabel(){return this.getAttribute("close-label")||"Close"}set closeLabel(t){this.setAttribute("close-label",null!=t?t.toString():t)}#E(){if(null===this.#t)return;let t=this.#t.querySelector(".dialog__close");null!==t&&((this.#i?.assignedElements()||[])?.some(t=>t.textContent?.replace(/\s/g,"")!=="")?t.removeAttribute("aria-label"):t.setAttribute("aria-label",this.closeLabel))}#e(){let t=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(this.noAnimations||t||this.#r)return;let e=this.#t;e&&"function"==typeof e.animate&&(this.#r=e.animate(q,F),this.#r.finished.catch(()=>{}).finally(()=>{this.#r=null}))}#o=()=>{this.open=!1,this.dispatchEvent(new CustomEvent("me-close",{bubbles:!0,composed:!0,detail:{element:this}})),document.body&&!this.preserveOverflow&&(document.body.style.overflow="")};#m=e=>{let o=this.#w(t.CLOSE_REQUEST_REASONS.ESCAPE_KEY);this.dispatchEvent(o),o.defaultPrevented&&(e.preventDefault(),this.#e())};#h=e=>{let o=this.#w(t.CLOSE_REQUEST_REASONS.CLOSE_BUTTON);this.dispatchEvent(o),o.defaultPrevented&&(e.preventDefault(),this.#e())};#c=e=>{let{target:o,currentTarget:i}=e,r=o===i,s=o instanceof HTMLElement&&null!==o.closest("[data-me-close]");if(!r&&!s)return;let a=r?t.CLOSE_REQUEST_REASONS.BACKDROP_CLICK:t.CLOSE_REQUEST_REASONS.EXTERNAL_INVOKER,n=this.#w(a);(this.dispatchEvent(n),n.defaultPrevented||r&&this.staticBackdrop)?this.#e():this.hide()};#d=e=>{switch(e.command){case"--me-open":if(this.open)return;this.show();return;case"--me-close":{if(!this.open)return;let e=this.#w(t.CLOSE_REQUEST_REASONS.EXTERNAL_INVOKER);if(this.dispatchEvent(e),e.defaultPrevented)return void this.#e();this.hide();return}default:return}};#a=()=>{if(null===this.#t)return;let t=this.#t.querySelector(".dialog__footer");if(null===t)return;let e=this.#s?.assignedNodes();t.hidden=!(e&&e.length>0)};#x=()=>{this.#E()};#w(t){return new CustomEvent("me-request-close",{bubbles:!0,composed:!0,cancelable:!0,detail:{reason:t,element:this}})}#p(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}show(){this.open||(this.open=!0)}hide(){this.open&&(this.open=!1)}static defineCustomElement(e="modal-element"){"u">typeof window&&!window.customElements.get(e)&&window.customElements.define(e,t)}}).defineCustomElement();var P=String.raw,$=class t extends EventTarget{#i=!1;#p=0;#t=0;#w=0;#s=0;#o=0;constructor(t){super();let{elapsed:e,duration:o}={elapsed:0,duration:1/0,...t};if("number"!=typeof e||Number.isNaN(e))throw TypeError("elapsed option must be a number");if("number"!=typeof o||Number.isNaN(o))throw TypeError("duration option must be a number");this.#i=!1,this.#p=Math.max(0,o),this.#t=Math.min(Math.max(0,e),this.#p),this.#w=this.#t,this.#s=0,this.#o=this.#t}#r(t){this.dispatchEvent(new Event(t))}#e=()=>{if(!this.#i)return;let e=t.now()-this.#s+this.#o;this.#t=Math.min(e,this.#p),this.#r("tick"),e<this.#p?requestAnimationFrame(this.#e):(this.#i=!1,this.#o=this.#t,this.#r("finish"))};on(t,e,o){return this.addEventListener(t,e,o),this}off(t,e,o){return this.removeEventListener(t,e,o),this}start(){return this.#i||this.#t>=this.#p||(this.#i=!0,this.#s=t.now(),this.#r("start"),requestAnimationFrame(this.#e)),this}stop(){return this.#i&&(this.#i=!1,this.#o=this.#t,this.#r("stop")),this}reset(){return this.#i=!1,this.#t=this.#w,this.#o=this.#w,this.#s=0,this.#r("reset"),this}time(){return{elapsed:this.#t,remaining:this.remaining}}get elapsed(){return this.#t}get remaining(){return Math.max(0,this.#p-this.#t)}get running(){return this.#i}static now(){return"performance"in window?performance.now():Date.now()}},V="alert-after-show",j="alert-after-hide",U=String.raw,G=String.raw,W=((t=Object.assign(document.createElement("div"),{className:"alert-toast-stack"})).attachShadow({mode:"open"}).innerHTML=P`
    <style>
      :host {
        display: contents;
        box-sizing: border-box;
...
`,Y=document.createElement("template");Y.innerHTML=U`
  <style>
    ${K}
  </style>
...
`,(class t extends HTMLElement{#i=!1;#p=null;#t=null;#w=null;#s=null;#o;static customAnimations;#r="api";#e=null;#v=null;#c=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(Y.content.cloneNode(!0))}static get observedAttributes(){return["open","duration","announce","close-label","countdown","focusable"]}attributeChangedCallback(t,e,o){if(!(!this.#i||e===o))switch(t){case"open":this.open?(this.duration!==1/0&&this.#e?.start(),this.#p?.removeAttribute("hidden"),this.#c?.style.setProperty("transform","scaleX(1)"),this.#l("alert-show"),this.#L(this.#p)?.finished.finally(()=>{this.#l(V)})):(this.duration!==1/0&&this.#e?.reset(),this.#l("alert-hide",{reason:this.#r}),this.#C(this.#p)?.finished.finally(()=>{this.#p?.setAttribute("hidden",""),this.#l(j,{reason:this.#r}),this.#r="api"}));break;case"duration":this.#e?.stop().off("tick",this.#h).off("finish",this.#m),this.#e=new $({duration:this.duration}).on("tick",this.#h).on("finish",this.#m),this.open&&this.duration!==1/0&&!this.#A()&&this.#e.start(),this.duration===1/0&&this.#c?.style.setProperty("transform","scaleX(1)");break;case"close-label":this.#n();break;case"announce":"none"!==this.announce?this.#p?.setAttribute("role",this.announce):this.#p?.removeAttribute("role");break;case"countdown":this.#v?.toggleAttribute("hidden",!this.countdown);break;case"focusable":this.focusable?this.#p?.setAttribute("tabindex","0"):this.#p?.removeAttribute("tabindex")}}get open(){return this.hasAttribute("open")}set open(t){this.toggleAttribute("open",!!t)}get variant(){return this.getAttribute("variant")||""}set variant(t){this.setAttribute("variant",t)}get announce(){let t=this.getAttribute("announce")??"";return this.#f(t)?t:"none"}set announce(t){this.setAttribute("announce",null!=t?t.toString():t)}get closable(){return this.hasAttribute("closable")}set closable(t){this.toggleAttribute("closable",!!t)}get closeLabel(){return this.getAttribute("close-label")||"Close"}set closeLabel(t){this.setAttribute("close-label",null!=t?t.toString():t)}get duration(){let t=this.getAttribute("duration");if(null===t||""===t)return 1/0;let e=Number(t);return e<=0?10:Number.isNaN(e)?1/0:e}set duration(t){this.setAttribute("duration",null!=t?t.toString():t)}get countdown(){return this.hasAttribute("countdown")}set countdown(t){this.toggleAttribute("countdown",!!t)}get focusable(){return this.hasAttribute("focusable")}set focusable(t){this.toggleAttribute("focusable",!!t)}get noAnimations(){return this.hasAttribute("no-animations")}set noAnimations(t){this.toggleAttribute("no-animations",!!t)}get customAnimations(){return this.#o}set customAnimations(t){this.#o=t}connectedCallback(){this.#E("open"),this.#E("variant"),this.#E("announce"),this.#E("closable"),this.#E("closeLabel"),this.#E("duration"),this.#E("countdown"),this.#E("focusable"),this.#E("noAnimations"),this.#E("customAnimations"),this.#p=this.shadowRoot?.querySelector(".alert")??null,this.#t=this.shadowRoot?.querySelector(".alert__close")??null,this.#w=this.shadowRoot?.querySelector('slot[name="close"]')??null,this.#v=this.shadowRoot?.querySelector(".alert__countdown")??null,this.#c=this.shadowRoot?.querySelector(".alert__countdown-elapsed")??null,this.#t?.addEventListener("click",this.#u),this.#w?.addEventListener("slotchange",this.#a),this.addEventListener("mouseenter",this.#x),this.addEventListener("mouseleave",this.#d),this.addEventListener("focusin",this.#x),this.addEventListener("focusout",this.#d),this.addEventListener("command",this.#b),this.#e=new $({duration:this.duration}).on("tick",this.#h).on("finish",this.#m),this.open?(this.duration!==1/0&&this.#e?.start(),this.#p?.removeAttribute("hidden")):this.#p?.setAttribute("hidden",""),this.closeLabel&&this.#n(),"none"!==this.announce?this.#p?.setAttribute("role",this.announce):this.#p?.removeAttribute("role"),this.focusable?this.#p?.setAttribute("tabindex","0"):this.#p?.removeAttribute("tabindex"),this.#v?.toggleAttribute("hidden",!this.countdown),this.#i=!0}disconnectedCallback(){this.#i=!1,this.#e?.stop().off("tick",this.#h).off("finish",this.#m),this.#e=null,this.#t?.removeEventListener("click",this.#u),this.#w?.removeEventListener("slotchange",this.#a),this.removeEventListener("mouseenter",this.#x),this.removeEventListener("mouseleave",this.#d),this.removeEventListener("focusin",this.#x),this.removeEventListener("focusout",this.#d),this.removeEventListener("command",this.#b)}connectedMoveCallback(){}#f(t){return"none"===t||"status"===t||"alert"===t||"alertdialog"===t}#h=t=>{if(!this.countdown||!this.#c)return;let{remaining:e}=t.currentTarget,o=e/this.duration;this.#c.style.transform=`scaleX(${o})`};#m=()=>{this.#r="timeout",this.open=!1};#u=()=>{this.closable&&(this.#r="user",this.open=!1)};#x=()=>{this.open&&this.duration!==1/0&&this.#e?.stop()};#d=()=>{!this.open||this.duration===1/0||this.#A()||this.#e?.start()};#a=()=>{this.#n()};#b=t=>{switch(t.command){case"--alert-show":this.open=!0;break;case"--alert-hide":this.#r="api",this.open=!1}};#n(){this.#t&&((this.#w?.assignedElements()||[])?.some(t=>t.textContent?.replace(/\s/g,"")!=="")?this.#t.removeAttribute("aria-label"):this.#t.setAttribute("aria-label",this.closeLabel))}#_(){let e=window.matchMedia("(prefers-reduced-motion: reduce)").matches,o={show:{keyframes:[{opacity:0,transform:"scale(0.9)"},{opacity:1,transform:"scale(1)"}],options:{duration:250,easing:"ease"}},hide:{keyframes:[{opacity:1,transform:"scale(1)"},{opacity:0,transform:"scale(0.9)"}],options:{duration:250,easing:"ease"}}},i=this.customAnimations||t.customAnimations||{},r=e||this.noAnimations||null===this.customAnimations||null===t.customAnimations,s=t=>{let e=i[t]?.options??{},s=o[t].options;return{...s,...e,duration:r?0:e.duration??s.duration}};return{show:{keyframes:i.show?.keyframes??o.show.keyframes,options:s("show")},hide:{keyframes:i.hide?.keyframes??o.hide.keyframes,options:s("hide")}}}#L(t){let{keyframes:e,options:o}=this.#_().show;return t?.animate(e,o)}#C(t){let{keyframes:e,options:o}=this.#_().hide;return t?.animate(e,o)}#l(t,e=null){let o=new CustomEvent(t,{bubbles:!0,composed:!0,detail:e});this.dispatchEvent(o)}#y(t,e){return new Promise(o=>{t.addEventListener(e,e=>{e.target===t&&o()},{once:!0})})}#A(){return this.matches(":focus-within")}show(){return this.open?Promise.resolve():(this.open=!0,this.#y(this,V))}hide(){return this.open?(this.open=!1,this.#y(this,j)):Promise.resolve()}toast(t={}){if(t={forceRestart:!1,...t},this.#s){if(!t.forceRestart)return this.#s.promise;this.#s.resolve(),this.#s.cleanup()}let e=()=>{},o=new Promise(t=>e=t),i=()=>{this.#s?.resolve(),this.#s?.cleanup()};this.#s={promise:o,resolve:e,cleanup:()=>{this.removeEventListener(j,i),this.parentNode===W&&W.removeChild(this),0===W.childElementCount&&W.remove(),this.open=!1,this.#s=null}},W.parentElement||document.body.append(W),W.appendChild(this),this.#p?.setAttribute("data-toast",""),this.open=!0;let r=W.shadowRoot?.querySelector(".stack");return r?.scrollTo({top:r.scrollHeight}),this.addEventListener(j,i,{once:!0}),o}#E(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static define(e="alert-element"){typeof window>"u"||window.customElements.get(e)||window.customElements.define(e,t)}}).define();let X=["image/jpg","image/jpeg","image/png","image/apng","image/gif","image/webp","image/avif"];function Z(t){return new Promise(function(e,o){t.oncomplete=t.onsuccess=function(){return e(t.result)},t.onabort=t.onerror=function(){return o(t.error)}})}function J(){var t,o,i;return e||(t="keyval",i=function(){if(o)return o;var e=indexedDB.open("keyval-store");return e.onupgradeneeded=function(){return e.result.createObjectStore(t)},(o=Z(e)).then(function(t){t.onclose=function(){return o=void 0}},function(){}),o},e=function(e,o){return i().then(function(i){return o(i.transaction(t,e).objectStore(t))})}),e}let Q="barcode-scanner/",tt="settings",te="history",to=async t=>{try{return[null,await function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:J();return e("readonly",function(e){return Z(e.get(t))})}(t)]}catch(t){return[t,void 0]}},ti=async(t,e)=>{try{return await function(t,e){var o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:J();return o("readwrite",function(o){return o.put(e,t),Z(o.transaction)})}(t,e),[null]}catch(t){return[t]}},tr=async()=>to(Q+tt),ts=async t=>ti(Q+tt,t),ta=async()=>to(Q+te),tn=async t=>ti(Q+te,t);function tl(t,e=0,o=!1){let i=null;if("function"!=typeof t)throw TypeError("Expected a function for first argument");return(...r)=>{clearTimeout(i),o&&!i&&t(...r),i=setTimeout(()=>{i=null,o||t(...r)},e)}}let td=(...t)=>{},tc=(...t)=>{};async function th(t,e){if(!t||!e)return;let o=Array.from(t.querySelectorAll("bs-result")).find(t=>t.getAttribute("value")===e);o&&o.remove();let i=document.createElement("bs-result");i.setAttribute("value",e),i.setAttribute("role","alert"),i.setAttribute("aria-live","assertive"),i.setAttribute("aria-atomic","true"),t.insertBefore(i,t.firstElementChild),t.scrollTop=0}let tu=(()=>{let t=new(window.AudioContext||window.webkitAudioContext||window.audioContext);if(t)return e=>{let{duration:o,frequency:i,volume:r,type:s,onEnded:a}=e,n=t.createOscillator(),l=t.createGain();n.connect(l),l.connect(t.destination),r&&(l.gain.value=r),i&&(n.frequency.value=i),s&&(n.type=s),"function"==typeof a&&(n.onended=a),n.start(t.currentTime),n.stop(t.currentTime+(o||500)/1e3)}})();async function tm(t=0){if("function"==typeof window.navigator.vibrate)try{window.navigator.vibrate(t)}catch{}}let tp=0;async function tb(t={}){let{success:e=!0}=t,[,o]=await tr();if(!o)return;let i=Date.now();i-tp<1e3||(o.beep&&tu(e?{duration:200,frequency:860,volume:.03,type:"square"}:{duration:300,frequency:200,volume:.05,type:"sawtooth"}),o.vibrate&&tm(e?100:200),tp=i)}function tg(t,e){if(!t||!e)return;let o=t.getBoundingClientRect();e.style.cssText=`width: ${o.width}px; height: ${o.height}px`}let tv=["aztec","code_128","code_39","code_93","codabar","data_matrix","ean_13","ean_8","itf","pdf417","qr_code","upc_a","upc_e"];class tf{static async polyfill(){if("BarcodeDetector"in window)td("Using the native BarcodeDetector API.");else try{await s("3jPiW"),td("Using BarcodeDetector polyfill.")}catch(t){throw Error("BarcodeDetector API is not supported by your browser.",{cause:t})}}static async getSupportedFormats(){let t=await window.BarcodeDetector.getSupportedFormats()||[];return tv.filter(e=>t.includes(e))}static async create(t){let e=Array.isArray(t)&&t.length>0?t:await tf.getSupportedFormats();return new tf(e)}static async setup(){try{return await tf.polyfill(),{barcodeReaderError:null}}catch(t){return{barcodeReaderError:t}}}constructor(t){this.barcodeReader=new window.BarcodeDetector({formats:t})}async detect(t){if(!this.barcodeReader)throw Error("BarcodeReader is not initialized.");let e=await this.barcodeReader.detect(t);if(Array.isArray(e)&&e.length>0){let t=e[0];return td({rawValue:t.rawValue,format:t.format}),t}throw Error("Could not detect barcode from provided source.")}}function ty(t={}){let{el:e,isTorchOn:o}={...{el:document.getElementById("torchButton"),isTorchOn:!1},...t},i=e.querySelectorAll("svg path");2===i.length&&(i[0].style.display=o?"none":"block",i[1].style.display=o?"block":"none",e.setAttribute("aria-label",`Turn ${o?"off":"on"} flash`))}function tw(t,e={}){var o;let i,r={duration:5e3,variant:"neutral",countdown:!1,announce:"status",icon:"",...e},s={info:`
    ...
    `}[r.icon||r.variant]||"";return Object.assign(document.createElement("alert-element"),{closable:!0,duration:r.duration,variant:r.variant,countdown:r.countdown,announce:r.announce,innerHTML:`${s?`<span slot="icon">${s}</span>`:""}${r.trustDangerousInnerHTML?t:(o=t,(i=document.createElement("div")).textContent=o,i.innerHTML)}`}).toast()}let tE="video-capture",tA=`
...
`,t_=document.createElement("template");t_.innerHTML=`
  ...
  <slot></slot>
`;class tx extends HTMLElement{#k={};#S=null;#T=null;constructor(){super(),this.#k=this.getSupportedConstraints(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(t_.content.cloneNode(!0))}static get observedAttributes(){return["no-image","pan","tilt","zoom","torch"]}attributeChangedCallback(t,e,o){if(!this.isConnected)return;let i=this.getTrackCapabilities();if("zoom"===t&&e!==o&&"zoom"in this.#k){let t=!!("zoom"in i&&i.zoom?.min&&i.zoom?.max)&&this.zoom>=i.zoom.min&&this.zoom<=i.zoom.max;"number"==typeof this.zoom&&t&&this.#z("zoom",this.zoom)}"torch"===t&&e!==o&&"torch"in this.#k&&this.#z("torch",this.torch)}async connectedCallback(){if(this.#R("autoPlay"),this.#R("facingMode"),this.#R("zoom"),this.#R("torch"),this.#T=this.shadowRoot?.querySelector("video")||null,this.#T?.addEventListener("loadedmetadata",this.#O),!tx.isSupported())return this.dispatchEvent(new CustomEvent(`${tE}:error`,{bubbles:!0,composed:!0,detail:{error:{name:"NotSupportedError",message:"Not supported"}}}));this.autoPlay&&this.startVideoStream()}disconnectedCallback(){this.stopVideoStream(),this.#T?.removeEventListener("loadedmetadata",this.#O)}get autoPlay(){return this.hasAttribute("auto-play")}set autoPlay(t){this.toggleAttribute("auto-play",!!t)}get facingMode(){let t=this.getAttribute("facing-mode");return"user"!==t?"environment":t}set facingMode(t){this.setAttribute("facing-mode",t)}get zoom(){return Number(this.getAttribute("zoom"))||1}set zoom(t){this.setAttribute("zoom",null!=t?t.toString():t)}get torch(){return this.hasAttribute("torch")}set torch(t){this.toggleAttribute("torch",!!t)}get loading(){return this.hasAttribute("loading")}#O=t=>{let e=t.target;e.play().then(()=>{this.dispatchEvent(new CustomEvent(`${tE}:video-play`,{bubbles:!0,composed:!0,detail:{video:e}}))}).catch(t=>{this.dispatchEvent(new CustomEvent(`${tE}:error`,{bubbles:!0,composed:!0,detail:{error:t}}))}).finally(()=>{this.removeAttribute("loading")})};#z(t,e){var o,i,r;if(!this.#S)return;let[s]=this.#S.getVideoTracks(),a=this.getTrackCapabilities(),n=this.getTrackSettings(),l="pan"===t||"tilt"===t||"zoom"===t?(o=Number(e),i=a[t]?.min||1,r=a[t]?.max||1,Number.isNaN(i)&&(i=0),Number.isNaN(r)&&(r=0),Math.min(Math.max(o,Math.min(i,r)),Math.max(i,r))):e;t in n&&s.applyConstraints({advanced:[{[t]:l}]}).catch(()=>{})}#R(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}async startVideoStream(t){if(!tx.isSupported()||this.#S)return;this.setAttribute("loading","");let e={video:{facingMode:{ideal:this.facingMode},pan:!0,tilt:!0,zoom:!0,torch:this.torch},audio:!1};if("string"==typeof t&&t.trim().length>0&&(e.video.deviceId={exact:t}),"string"==typeof this.cameraResolution&&this.cameraResolution.trim().length>0){let[t=0,o=0]=this.cameraResolution.split("x").map(t=>Number(t));t>0&&o>0&&(e.video.width=t,e.video.height=o)}try{this.#S=await navigator.mediaDevices.getUserMedia(e),this.#T&&(this.#T.srcObject=this.#S),this.#z("pan",this.pan),this.#z("tilt",this.tilt),this.#z("zoom",this.zoom)}catch(t){this.dispatchEvent(new CustomEvent(`${tE}:error`,{bubbles:!0,composed:!0,detail:{error:t}}))}finally{this.removeAttribute("loading")}}restartVideoStream(t){this.#S&&this.#T&&this.stopVideoStream(),this.startVideoStream(t)}stopVideoStream(){if(!this.#T||!this.#S)return;let[t]=this.#S.getVideoTracks();t?.stop(),this.#T.srcObject=null,this.#S=null}getSupportedConstraints(){return tx.isSupported()&&navigator.mediaDevices.getSupportedConstraints()||{}}getTrackCapabilities(){if(!this.#S)return{};let[t]=this.#S.getVideoTracks();return t&&"function"==typeof t.getCapabilities&&t.getCapabilities()||{}}getTrackSettings(){if(!this.#S)return{};let[t]=this.#S.getVideoTracks();return t&&"function"==typeof t.getSettings&&t.getSettings()||{}}static async getVideoInputDevices(){return navigator.mediaDevices&&navigator.mediaDevices.enumerateDevices?(await navigator.mediaDevices.enumerateDevices()||[]).filter(t=>"videoinput"===t.kind&&!!t.deviceId):[]}static isSupported(){return!!navigator.mediaDevices?.getUserMedia}static defineCustomElement(t=tE){"u">typeof window&&!window.customElements.get(t)&&window.customElements.define(t,tx)}}var tL="clipboard-copy",tC="success",tk="error",tS=document.createElement("template"),tT=`
  :host([hidden]),
  [hidden],
  ::slotted([hidden]) {
    display: none !important;
...
`;class tD extends HTMLElement{constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tI.content.cloneNode(!0))}get value(){return this.getAttribute("value")}set value(t){this.setAttribute("value",t)}static get observedAttributes(){return["value"]}attributeChangedCallback(t,e,o){"value"===t&&e!==o&&this.#N(this.value)}connectedCallback(){if(this.#R("value"),this.#M(),!tO()){let t=this.shadowRoot.querySelector("web-share");t&&(t.hidden=!0)}}async #N(t){let e,o=this.shadowRoot.querySelector(".result"),i=o?.querySelector(".result__content"),r=o?.querySelector(".result__datetime"),s=o?.querySelector(".result__item");s&&s?.remove();try{let[,o]=await tr();new URL(t),(e=document.createElement("a")).href=t,o?.openWebPageSameTab||(e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")),o?.openWebPage?e.click():window.requestAnimationFrame(()=>e.focus())}catch{e=document.createElement("span")}e.className="result__item",e.part="result__item",e.textContent=t,r.textContent=tN.format(new Date),i?.insertBefore(e,r);let a=o?.querySelector("custom-clipboard-copy"),n=o?.querySelector("web-share");if(a){let e=a.shadowRoot?.querySelector("button");a.setAttribute("value",t),e?.setAttribute("aria-label",`Copy to clipboard ${t}`),a.hidden=!1}if(n&&tO()){let e=n.querySelector("button");n.setAttribute("share-text",t),n.hidden=!1,e?.setAttribute("aria-label",`Share ${t}`)}}#M(){if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;let t=this.shadowRoot.querySelector(".result");t?.animate([{backgroundColor:"var(--highlight)"},{backgroundColor:"transparent"}],{duration:400,easing:"ease-out"})}#R(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="bs-result"){"u">typeof window&&!window.customElements.get(t)&&window.customElements.define(t,tD)}}tD.defineCustomElement();class tq extends HTMLElement{#I=null;#D=null;#q=[];#F;constructor(){super()}get supportedFormats(){return this.#q}set supportedFormats(t){this.#q=t,this.#B()}async connectedCallback(){this.#R("supportedFormats"),this.#I=this.querySelector("#formatsList"),this.#D=this.querySelector("form");let[,t]=await tr();this.#F=t??{},this.#D?.querySelectorAll('[name="general-settings"]').forEach(t=>{t.checked=this.#F[t.value]})}#B(){if(!this.#I)return;let t=this.#F?.formats;this.#I.replaceChildren(),this.supportedFormats.forEach(e=>{let o=document.createElement("li"),i=document.createElement("label"),r=document.createElement("input");r.type="checkbox",r.name="formats-settings",r.value=e,r.checked=null==t||t.includes(e),i.appendChild(r),i.appendChild(document.createTextNode(e)),o.appendChild(i),this.#I.appendChild(o)})}#R(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="bs-settings"){"u">typeof window&&!window.customElements.get(t)&&window.customElements.define(t,tq)}}tq.defineCustomElement();let tF=`
  :host {
...
`;class tH extends HTMLElement{#H=null;#P=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tB.content.cloneNode(!0))}async connectedCallback(){this.#H=this.shadowRoot?.getElementById("historyList"),this.#P=this.shadowRoot?.getElementById("emptyHistoryBtn"),this.#$((await ta())[1]||[]),this.#H?.addEventListener("click",this.#V),this.#P?.addEventListener("click",this.#j)}disconnectedCallback(){this.#H?.removeEventListener("click",this.#V),this.#P?.removeEventListener("click",this.#j)}async add(t){if(!t)return;let e={type:"add",message:"Error adding barcode to history"},[o,i=[]]=await ta();if(o||!Array.isArray(i))return this.#U("bs-history-error",e),o;if(i.find(e=>e===t))return;let r=[...i,t],[s]=await tn(r);return s?(tc("Error setting history",s),this.#U("bs-history-error",e),s):(this.#H?.insertBefore(this.#G(t),this.#H.firstElementChild),this.#U("bs-history-success",{type:"add",message:"Barcode added to history"}),null)}async remove(t){if(!t)return;let e={type:"remove",message:"Error removing barcode from history"},[o,i=[]]=await ta();if(o||!Array.isArray(i))return this.#U("bs-history-error",e),o;let r=i.filter(e=>e!==t),[s]=await tn(r);if(s)return tc("Error setting history",s),this.#U("bs-history-error",e),s;let a=this.#H?.querySelector(`li[data-value="${t}"]`);return a?.remove(),this.#U("bs-history-success",{type:"remove",message:"Barcode removed from history"}),null}async empty(){let[t]=await tn([]);return t?(tc("Error setting history",t),this.#U("bs-history-error",{type:"empty",message:"Error emptying history"}),t):(this.#H?.replaceChildren(),this.#U("bs-history-success",{type:"empty",message:"History emptied successfully"}),null)}#$(t){if(!this.#H)return;this.#H.replaceChildren();let e=document.createDocumentFragment();[...t].reverse().forEach(t=>e.appendChild(this.#G(t))),this.#H.appendChild(e)}#G(t){let e,o=document.createElement("li");o.setAttribute("data-value",t);try{new URL(t),(e=document.createElement("a")).href=t,e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")}catch{e=document.createElement("span")}e.textContent=t;let i=document.createElement("div");i.className="actions";let r=document.createElement("custom-clipboard-copy"),s=r.shadowRoot?.querySelector("button");r.setAttribute("only-icon",""),r.setAttribute("value",t),s?.setAttribute("aria-label",`Copy to clipboard ${t}`),i.appendChild(r);let a=document.createElement("button");return a.type="button",a.className="delete-action",a.setAttribute("data-action","delete"),a.setAttribute("aria-label",`Remove from history ${t}`),a.innerHTML=`
    ...
    `,i.appendChild(a),o.appendChild(e),o.appendChild(i),o}#V=async t=>{let e=t.target;if(e.closest('[data-action="delete"]')){let t=e.closest("li").dataset.value;window.confirm(`Delete history item ${t}?`)&&this.remove(t)}};#j=async()=>{window.confirm("Empty history? This action cannot be undone.")&&this.empty()};#U(t,e=null){let o=new CustomEvent(t,{bubbles:!0,composed:!0,detail:e});this.dispatchEvent(o)}static defineCustomElement(t="bs-history"){"u">typeof window&&!window.customElements.get(t)&&window.customElements.define(t,tH)}}tH.defineCustomElement(),async function(){let t=document.querySelector("a-tab-group"),e=document.querySelector("video-capture"),o=document.querySelector("bs-settings"),i=document.querySelector("bs-history"),r=document.getElementById("cameraPanel"),s=r.querySelector(".results"),a=document.getElementById("filePanel").querySelector(".results"),n=document.getElementById("scanInstructions"),l=document.getElementById("scanBtn"),d=document.getElementById("dropzone"),c=document.querySelector("resize-observer"),h=document.getElementById("scanFrame"),u=document.getElementById("torchButton"),m=document.getElementById("globalActions"),p=document.getElementById("historyBtn"),b=document.getElementById("historyDialog"),g=document.getElementById("settingsBtn"),v=document.getElementById("settingsDialog"),f=document.getElementById("settingsForm"),y=document.getElementById("cameraSelect"),w=null,E=!0;"function"==typeof HTMLDialogElement&&(m?.removeAttribute("hidden"),b?.removeAttribute("hidden"),v?.removeAttribute("hidden"));let{barcodeReaderError:A}=await tf.setup();if(A){let e=document.getElementById("barcodeReaderError");E=!1,m?.setAttribute("hidden",""),t?.setAttribute("hidden",""),e?.setAttribute("open","");return}let _=await tf.getSupportedFormats(),[,x]=await tr(),L=x?.formats||_,C=await tf.create(L);e.addEventListener("video-capture:video-play",O,{once:!0}),e.addEventListener("video-capture:error",function(t){let e=t.detail.error;if("NotFoundError"===e.name)return;let o="NotAllowedError"===e.name?"<strong>Error accessing camera</strong><br>Permission to use webcam was denied or video Autoplay is disabled. Reload the page to give appropriate permissions to webcam.":e.message;r.innerHTML=`
    ...
    `},{once:!0}),tx.defineCustomElement();let k=e?.shadowRoot,S=k?.querySelector("video"),T=k?.querySelector('[part="actions-container"]');async function z(){if(E){td("Scanning..."),n?.removeAttribute("hidden");try{let[,t]=await tr(),e=await C.detect(S),o=e?.rawValue??"";if(!o)throw Error("No barcode detected");if(th(s,o),t?.addToHistory&&i?.add(o),tb(),!t?.continueScanning){w&&(clearTimeout(w),w=null),l?.removeAttribute("hidden"),h?.setAttribute("hidden",""),T?.setAttribute("hidden","");return}}catch{}E&&(w=setTimeout(()=>z(),1e3))}}async function R(t){if(!t)return;let[,e]=await tr(),o=new Image,r=new FileReader;r.onload=r=>{let s=r.target.result;o.onload=async()=>{try{let t=await C.detect(o),r=t?.rawValue??"";if(!r)throw Error("No barcode detected");th(a,r),e?.addToHistory&&i?.add(r),tb()}catch(t){tc(t),tw("<strong>No barcode detected</strong><br><small>Please try again with a different image.</small>",{variant:"danger",announce:"alert",trustDangerousInnerHTML:!0}),tb({success:!1})}},o.src=s,o.alt="Image preview",d.replaceChildren();let n=document.createElement("div");n.className="dropzone-preview";let l=document.createElement("div");l.className="dropzone-preview__image-wrapper";let c=document.createElement("div");c.className="dropzone-preview__file-name",c.textContent=t.name,l.appendChild(o),n.appendChild(l),n.appendChild(c),d.prepend(n)},r.readAsDataURL(t)}async function O(t){h?.removeAttribute("hidden"),tg(t.detail.video,h),z();let o=t.target.getTrackSettings(),i=t.target.getTrackCapabilities(),r=document.getElementById("zoomLevel");if(i?.torch&&(u?.addEventListener("click",M),u?.removeAttribute("hidden"),e.hasAttribute("torch")&&ty({el:u,isTorchOn:!0})),o?.zoom&&i?.zoom){let t=document.getElementById("zoomControls"),s=i?.zoom?.min||0,a=i?.zoom?.max||10,n=o?.zoom||1;t?.addEventListener("click",t=>{let o=t.target.closest('[data-action="zoom-in"]'),i=t.target.closest('[data-action="zoom-out"]');o&&n<a&&(n+=.5),i&&n>s&&(n-=.5),r.textContent=n.toFixed(1),e.zoom=n}),t?.removeAttribute("hidden"),r.textContent=n.toFixed(1)}let s=await tx.getVideoInputDevices();s.forEach((t,e)=>{let o=document.createElement("option");o.value=t.deviceId,o.textContent=t.label||`Camera ${e+1}`,y.appendChild(o)}),s.length>1&&(y?.addEventListener("change",I),y?.removeAttribute("hidden"))}async function N(t){t.preventDefault();let e={},o=new FormData(f),i=o.getAll("general-settings"),r=o.getAll("formats-settings");i.forEach(t=>e[t]=!0),e.formats=r,ts(e),"formats-settings"===t.target.name&&(C=await tf.create(r))}function M(t){e.torch=!e.torch,ty({el:t.currentTarget,isTorchOn:e.hasAttribute("torch")})}function I(t){if("function"!=typeof e.restartVideoStream)return;let o=t.target.value||void 0;e.restartVideoStream(o)}d.accept=X.join(","),o.supportedFormats=_,l.addEventListener("click",function(){l?.setAttribute("hidden",""),h?.removeAttribute("hidden"),T?.removeAttribute("hidden"),z()}),t.addEventListener("a-tab-show",tl(function(t){let e=t.detail.tabId,o=document.querySelector("video-capture");if("cameraTab"===e){if(E=!0,!o)return;if(!o.loading&&l.hasAttribute("hidden")&&(h?.removeAttribute("hidden"),T?.removeAttribute("hidden"),z()),"function"==typeof o.startVideoStream){let t=y?.value||void 0;o.startVideoStream(t)}}else"fileTab"===e&&(E=!1,null!=o&&"function"==typeof o.stopVideoStream&&o.stopVideoStream(),h?.setAttribute("hidden",""),T?.setAttribute("hidden",""))},250)),d.addEventListener("files-dropzone-drop",function(t){R(t.detail.acceptedFiles[0])}),c.addEventListener("resize-observer:resize",function(){tg(e.shadowRoot.querySelector("video"),h)}),g.addEventListener("click",function(){v.open=!0}),f.addEventListener("change",tl(N,500)),p.addEventListener("click",function(){b.open=!0}),document.addEventListener("visibilitychange",function(){if("cameraTab"===t.querySelector("[selected]").getAttribute("id"))if("hidden"===document.visibilityState)E=!1,null!=e&&"function"==typeof e.stopVideoStream&&e.stopVideoStream();else{E=!0;let t=document.querySelector("video-capture");if(!t)return;if(!t.loading&&l.hasAttribute("hidden")&&z(),"function"==typeof t.startVideoStream){let e=y?.value||void 0;t.startVideoStream(e)}}}),document.addEventListener("keydown",function(e){let o,i,r,s;"Escape"===e.key&&(o=t.querySelector("#cameraTab").hasAttribute("selected"),i=!l.hidden,r=v.hasAttribute("open"),s=b.hasAttribute("open"),i&&o&&!(r||s)&&l.click())}),document.addEventListener("bs-history-success",function(t){let{type:e,message:o}=t.detail;"add"===e&&tw(o,{variant:"success"})}),document.addEventListener("bs-history-error",function(t){let{type:e,message:o}=t.detail;("remove"===e||"empty"===e)&&b?.hide(),tw(o,{variant:"danger",announce:"alert"})})}();
//# sourceMappingURL=barcode-scanner.f673e5e8.js.map
