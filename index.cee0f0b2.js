 ...
 * @author George Raptis <georapbox@gmail.com>
 * @license MIT
 */var tv="clipboard-copy",tw="success",ty="error",tE=document.createElement("template"),tA=`
  :host([hidden]),
  [hidden],
  ::slotted([hidden]) {
    display: none !important;
