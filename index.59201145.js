...
`;class j extends HTMLElement{#e=null;#t=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open",delegatesFocus:!0}).appendChild(F.content.cloneNode(!0)),this.shadowRoot&&(this.#e=this.shadowRoot.getElementById("file-input"),this.#t=this.shadowRoot.getElementById("dropzone"))}static get observedAttributes(){return["accept","disabled","multiple"]}attributeChangedCallback(t,e,i){"accept"===t&&e!==i&&this.#e&&(this.#e.accept=this.accept),"disabled"===t&&e!==i&&this.#e&&(this.#e.disabled=this.disabled,this.disabled?(this.#t?.removeAttribute("tabindex"),this.#t?.setAttribute("aria-disabled","true")):(this.#t?.setAttribute("tabindex","0"),this.#t?.setAttribute("aria-disabled","false"))),"multiple"===t&&e!==i&&this.#e&&(this.#e.multiple=this.multiple)}connectedCallback(){this.#s("accept"),this.#s("disabled"),this.#s("maxFiles"),this.#s("maxSize"),this.#s("minSize"),this.#s("multiple"),this.#s("autoFocus"),this.#s("noStyle"),this.#e?.addEventListener("change",this.#n),this.#t?.addEventListener("dragenter",this.#r),this.#t?.addEventListener("dragover",this.#o),this.#t?.addEventListener("dragleave",this.#l),this.#t?.addEventListener("drop",this.#i),this.#t?.addEventListener("click",this.#c),this.#t?.addEventListener("keyup",this.#a),this.autoFocus&&this.#t?.focus()}disconnectedCallback(){this.#e?.removeEventListener("change",this.#n),this.#t?.removeEventListener("dragenter",this.#r),this.#t?.removeEventListener("dragover",this.#o),this.#t?.removeEventListener("dragleave",this.#l),this.#t?.removeEventListener("drop",this.#i),this.#t?.removeEventListener("click",this.#c),this.#t?.removeEventListener("keyup",this.#a)}get accept(){return this.getAttribute("accept")||""}set accept(t){this.setAttribute("accept",null!=t?t.toString():t)}get disabled(){return this.hasAttribute("disabled")}set disabled(t){this.toggleAttribute("disabled",!!t)}get maxFiles(){let t=Number(this.getAttribute("max-files"))||0;return t<=0?1/0:Math.floor(Math.abs(t))}set maxFiles(t){this.setAttribute("max-files",null!=t?t.toString():t)}get maxSize(){let t=this.getAttribute("max-size");if(null===t)return 1/0;let e=Number(t);return Number.isNaN(e)?1/0:e}set maxSize(t){this.setAttribute("max-size",null!=t?t.toString():t)}get minSize(){let t=this.getAttribute("min-size");if(null===t)return 0;let e=Number(t);return Number.isNaN(e)?0:e}set minSize(t){this.setAttribute("min-size",null!=t?t.toString():t)}get multiple(){return this.hasAttribute("multiple")}set multiple(t){this.toggleAttribute("multiple",!!t)}get autoFocus(){return this.hasAttribute("auto-focus")}set autoFocus(t){this.toggleAttribute("auto-focus",!!t)}get noStyle(){return this.hasAttribute("no-style")}set noStyle(t){this.toggleAttribute("no-style",!!t)}#n=async t=>{try{this.#b(await I(t))}catch(t){this.dispatchEvent(new CustomEvent(`${$}-error`,{bubbles:!0,composed:!0,detail:{error:t}}))}};#r=()=>{this.disabled||this.dispatchEvent(new Event(`${$}-dragenter`,{bubbles:!0,composed:!0}))};#o=t=>{if(t.preventDefault(),this.disabled){t.dataTransfer.dropEffect="none";return}t.dataTransfer.dropEffect="copy",this.#t&&(this.#t.classList.add("dropzone--dragover"),this.#t.part.add("dropzone--dragover")),this.dispatchEvent(new Event(`${$}-dragover`,{bubbles:!0,composed:!0}))};#l=()=>{this.disabled||(this.#t&&(this.#t.classList.remove("dropzone--dragover"),this.#t.part.remove("dropzone--dragover")),this.dispatchEvent(new Event(`${$}-dragleave`,{bubbles:!0,composed:!0})))};#i=async t=>{if(!this.disabled){t.preventDefault(),this.#t&&(this.#t.classList.remove("dropzone--dragover"),this.#t.part.remove("dropzone--dragover"));try{this.#b(await I(t))}catch(t){this.dispatchEvent(new CustomEvent(`${$}-error`,{bubbles:!0,composed:!0,detail:{error:t}}))}}};#c=()=>{this.disabled||this.#e?.click()};#a=t=>{this.disabled||" "!==t.key&&"Enter"!==t.key||this.#e?.click()};#b(t){if(!Array.isArray(t)||!t.length)return;let e=[],i=[],o=t.length;if(!this.multiple&&o>1)for(let e of t)i.push({file:e,errors:[{code:B,message:"Too many files selected. Only 1 file is allowed."}]});else if(this.multiple&&o>this.maxFiles)for(let e of t)i.push({file:e,errors:[{code:B,message:`Too many files selected. Only ${this.maxFiles} ${this.maxFiles>1?"files are":"file is"} allowed.`}]});else for(let o of t){let t=function(t,e=""){if(!e)return!0;let i=[...new Set(e.split(",").map(t=>t.trim()).filter(Boolean))],o=t.type,s=o.replace(/\/.*$/,"");for(let e of i)if("."===e.charAt(0)){if(-1!==t.name.toLowerCase().indexOf(e.toLowerCase(),t.name.length-e.length))return!0}else if(/\/\*$/.test(e)){if(s===e.replace(/\/.*$/,""))return!0}else if(o===e)return!0;return!1}(o,this.accept),s=o.size>this.maxSize,a=o.size<this.minSize;if(!t||s||a){let e=[];t||e.push({code:"INVALID_MIME_TYPE",message:`File type "${o.type}" is not accepted.`}),s&&e.push({code:"FILE_TOO_LARGE",message:`File size ${o.size} exceeds the maximum size of ${this.maxSize}.`}),a&&e.push({code:"FILE_TOO_SMALL",message:`File size ${o.size} is smaller than the minimum size of ${this.minSize}.`}),i.push({file:o,errors:e})}else e.push(o)}this.dispatchEvent(new CustomEvent(`${$}-drop`,{bubbles:!0,composed:!0,detail:{acceptedFiles:e,rejectedFiles:i}})),e.length>0&&this.dispatchEvent(new CustomEvent(`${$}-drop-accepted`,{bubbles:!0,composed:!0,detail:{acceptedFiles:e}})),i.length>0&&this.dispatchEvent(new CustomEvent(`${$}-drop-rejected`,{bubbles:!0,composed:!0,detail:{rejectedFiles:i}})),this.#e&&(this.#e.value=this.#e.defaultValue)}openFileDialog(){this.disabled||this.#e?.click()}#s(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t=$){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,j)}}function H(t){return null!==t&&"object"==typeof t?"share"in navigator&&"canShare"in navigator&&navigator.canShare(t):"share"in navigator}function P(t,e,i){if(!e.has(t))throw TypeError("attempted to "+i+" private field on non-instance");return e.get(t)}function V(t,e){var i;return(i=P(t,e,"get")).get?i.get.call(t):i.value}function U(t,e){if(e.has(t))throw TypeError("Cannot initialize the same private elements twice on an object")}function W(t,e,i){U(t,e),e.set(t,i)}function Z(t,e,i){return function(t,e,i){if(e.set)e.set.call(t,i);else{if(!e.writable)throw TypeError("attempted to set read only private field");e.value=i}}(t,P(t,e,"set"),i),i}function G(t,e,i){if(!e.has(t))throw TypeError("attempted to get private field on non-instance");return i}function Y(t,e){U(t,e),e.add(t)}j.defineCustomElement(),Object.defineProperty({},"ResizeObserverElement",{get:function(){return ta},set:t,enumerable:!0,configurable:!0});const K=document.createElement("template"),X=String.raw;K.innerHTML=X`
  ...
  <slot></slot>
`;var J=new WeakMap,Q=new WeakMap,tt=new WeakMap,te=new WeakSet,ti=new WeakSet,to=new WeakMap,ts=new WeakSet;class ta extends HTMLElement{static get observedAttributes(){return["disabled"]}attributeChangedCallback(t,e,i){"disabled"===t&&e!==i&&(this.disabled?G(this,ti,tr).call(this):G(this,te,tn).call(this))}connectedCallback(){G(this,ts,tl).call(this,"disabled"),"ResizeObserver"in window&&(Z(this,Q,new ResizeObserver(t=>{this.dispatchEvent(new CustomEvent("resize-observer:resize",{bubbles:!0,composed:!0,detail:{entries:t}}))})),this.disabled||G(this,te,tn).call(this),V(this,J).addEventListener("slotchange",V(this,to)))}disconnectedCallback(){G(this,ti,tr).call(this),V(this,J).removeEventListener("slotchange",V(this,to))}get disabled(){return this.hasAttribute("disabled")}set disabled(t){t?this.setAttribute("disabled",""):this.removeAttribute("disabled")}static defineCustomElement(t="resize-observer"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,ta)}constructor(){super(),Y(this,te),Y(this,ti),Y(this,ts),W(this,J,{writable:!0,value:void 0}),W(this,Q,{writable:!0,value:void 0}),W(this,tt,{writable:!0,value:void 0}),W(this,to,{writable:!0,value:()=>{this.disabled||G(this,te,tn).call(this)}}),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(K.content.cloneNode(!0))),Z(this,J,this.shadowRoot.querySelector("slot")),Z(this,Q,null),Z(this,tt,[])}}function tn(){V(this,J)&&V(this,Q)&&(V(this,tt).forEach(t=>V(this,Q).unobserve(t)),Z(this,tt,[]),V(this,J).assignedElements().forEach(t=>{V(this,Q).observe(t),V(this,tt).push(t)}))}function tr(){V(this,Q)&&V(this,Q).disconnect()}function tl(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}ta.defineCustomElement();let td=(t,e,i)=>(Number.isNaN(e)&&(e=0),Number.isNaN(i)&&(i=0),Math.min(Math.max(t,Math.min(e,i)),Math.max(e,i))),tc="capture-photo",th=`
  :host {
    display: block;
    box-sizing: border-box;
  }
...
//# sourceMappingURL=index.59201145.js.map
