...
export function renderHistoryList(data) {
  ...
  if (!Array.isArray(data) || data.length === 0) {
    ...
    data.forEach((item, index) => {
      ...
      copyBtn.setAttribute('aria-labelledby', `historyItem-${index} copyHistoryItem-${index}`);
      ...
      removeBtn.setAttribute('aria-labelledby', `historyItem-${index} removeHistoryItem-${index}`);
