var t,e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},o={},i={},s=e.parcelRequirea202;null==s&&((s=function(t){if(t in o)return o[t].exports;if(t in i){var e=i[t];delete i[t];var s={id:t,exports:{}};return o[t]=s,e.call(s.exports,s,s.exports),s.exports}var r=Error("Cannot find module '"+t+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(t,e){i[t]=e},e.parcelRequirea202=s);var r=s.register;r("cw9o9",function(t,e){var o=s("hffE7");t.exports=o("6z40I").then(()=>s("aexh3"))}),r("hffE7",function(t,e){t.exports=function(t){return import(s("kyEFX").resolve(t))}});/*!
...
`,(class t extends HTMLElement{#t=null;#e=null;#o=!1;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(w.content.cloneNode(!0))}static get observedAttributes(){return["placement","no-scroll-controls"]}attributeChangedCallback(t,e,o){"placement"===t&&e!==o&&this.#i(),"no-scroll-controls"===t&&e!==o&&this.#i()}get placement(){return this.getAttribute("placement")||p.TOP}set placement(t){null!=t&&this.setAttribute("placement",t)}get noScrollControls(){return this.hasAttribute("no-scroll-controls")}set noScrollControls(t){this.toggleAttribute("no-scroll-controls",!!t)}get scrollDistance(){return Math.abs(Number(this.getAttribute("scroll-distance")))||200}set scrollDistance(t){this.setAttribute("scroll-distance",Math.abs(t).toString()||"200")}get activation(){return this.getAttribute("activation")||v.AUTO}set activation(t){this.setAttribute("activation",t||v.AUTO)}get noTabCycling(){return this.hasAttribute("no-tab-cycling")}set noTabCycling(t){this.toggleAttribute("no-tab-cycling",!!t)}connectedCallback(){this.#s("placement"),this.#s("noScrollControls"),this.#s("scrollDistance"),this.#s("activation"),this.#s("noTabCycling");let t=this.shadowRoot?.querySelector("slot[name=tab]"),e=this.shadowRoot?.querySelector("slot[name=panel]"),o=this.shadowRoot?.querySelector(".tab-group__tabs"),i=this.shadowRoot?.querySelector(".tab-group__nav"),s=Array.from(this.shadowRoot?.querySelectorAll(".tab-group__scroll-button")||[]);t?.addEventListener("slotchange",this.#r),e?.addEventListener("slotchange",this.#r),o?.addEventListener("click",this.#a),o?.addEventListener("keydown",this.#n),s.forEach(t=>t.addEventListener("click",this.#l)),this.addEventListener("a-tab-close",this.#d),"ResizeObserver"in window&&(this.#t=new ResizeObserver(t=>{this.#e=window.requestAnimationFrame(()=>{let e=t?.[0]?.target,o=e?.scrollWidth>e?.clientWidth;s.forEach(t=>t.toggleAttribute("hidden",!o)),i?.part.toggle("nav--has-scroll-controls",o),i?.classList.toggle("tab-group__nav--has-scroll-controls",o)})})),this.#c(),this.#i()}disconnectedCallback(){let t=this.shadowRoot?.querySelector("slot[name=tab]"),e=this.shadowRoot?.querySelector("slot[name=panel]"),o=this.shadowRoot?.querySelector(".tab-group__tabs"),i=Array.from(this.shadowRoot?.querySelectorAll(".tab-group__scroll-button")||[]);t?.removeEventListener("slotchange",this.#r),e?.removeEventListener("slotchange",this.#r),o?.removeEventListener("click",this.#a),o?.removeEventListener("keydown",this.#n),i.forEach(t=>t.removeEventListener("click",this.#l)),this.removeEventListener("a-tab-close",this.#d),this.#h()}#u(){if(!this.#t)return;let t=this.shadowRoot?.querySelector(".tab-group__tabs");t&&(this.#t.unobserve(t),this.#t.observe(t))}#h(){this.#t&&(this.#t.disconnect(),null!==this.#e&&(window.cancelAnimationFrame(this.#e),this.#e=null))}#m(){return window.CSS.supports("selector(:dir(ltr))")?this.matches(":dir(ltr)")?b.LTR:b.RTL:window.getComputedStyle(this).direction||b.LTR}#c(){this.hidden=0===this.#p().length}#b(){let t=this.#p();this.#c(),t.forEach(t=>{let e=t.nextElementSibling;if(!e||"a-tab-panel"!==e.tagName.toLowerCase())return console.error(`Tab #${t.id} is not a sibling of a <a-tab-panel>`);t.setAttribute("aria-controls",e.id),e.setAttribute("aria-labelledby",t.id)})}#g(){return Array.from(this.querySelectorAll("a-tab-panel"))}#p(){return Array.from(this.querySelectorAll("a-tab"))}#v(t){let e=t.getAttribute("aria-controls");return this.querySelector(`#${e}`)}#f(){return this.#p().find(t=>!t.disabled)||null}#y(){let t=this.#p();for(let e=t.length-1;e>=0;e--)if(!t[e].disabled)return t[e];return null}#w(){let t=this.#p(),e=this.activation===v.MANUAL?t.findIndex(t=>t.matches(":focus"))-1:t.findIndex(t=>t.selected)-1;for(;t[(e+t.length)%t.length].disabled;)e--;return this.noTabCycling&&e<0?null:t[(e+t.length)%t.length]}#E(){let t=this.#p(),e=this.activation===v.MANUAL?t.findIndex(t=>t.matches(":focus"))+1:t.findIndex(t=>t.selected)+1;for(;t[e%t.length].disabled;)e++;return this.noTabCycling&&e>=t.length?null:t[e%t.length]}#A(){let t=this.#p(),e=this.#g();t.forEach(t=>t.selected=!1),e.forEach(t=>t.hidden=!0)}#i(){let t=this.shadowRoot?.querySelector(".tab-group__nav"),e=this.shadowRoot?.querySelector(".tab-group__tabs"),o=Array.from(this.shadowRoot?.querySelectorAll(".tab-group__scroll-button")||[]);this.noScrollControls||this.placement===p.START||this.placement===p.END?(this.#h(),o.forEach(t=>t.hidden=!0),t?.part.remove("nav--has-scroll-controls"),t?.classList.remove("tab-group__nav--has-scroll-controls"),e?.setAttribute("aria-orientation","vertical")):(this.#u(),o.forEach(t=>t.hidden=!1),e?.setAttribute("aria-orientation","horizontal"))}#x(){let t=this.#p(),e=t.find(t=>t.selected&&!t.disabled)||t.find(t=>!t.disabled);e&&(this.#o&&!e.selected&&this.dispatchEvent(new CustomEvent("a-tab-show",{bubbles:!0,composed:!0,detail:{tabId:e.id}})),this.#k(e))}#k(t){this.#A(),t&&(t.selected=!0);let e=this.#v(t);e&&(e.hidden=!1)}#r=t=>{this.#b(),this.#i(),this.#x(),"tab"===t.target.name&&(this.#o=!0)};#n=t=>{if("a-tab"!==t.target.tagName.toLowerCase()||t.altKey)return;let e=g.includes(this.placement||"")?this.placement:p.TOP,o=[p.TOP,p.BOTTOM].includes(e||"")?"horizontal":"vertical",i=this.#m(),s=null;switch(t.key){case f.LEFT:"horizontal"===o&&(s=i===b.LTR?this.#w():this.#E())&&(this.activation===v.MANUAL?s.focus():this.selectTab(s));break;case f.RIGHT:"horizontal"===o&&(s=i===b.LTR?this.#E():this.#w())&&(this.activation===v.MANUAL?s.focus():this.selectTab(s));break;case f.UP:"vertical"===o&&(s=this.#w())&&(this.activation===v.MANUAL?s.focus():this.selectTab(s));break;case f.DOWN:"vertical"===o&&(s=this.#E())&&(this.activation===v.MANUAL?s.focus():this.selectTab(s));break;case f.HOME:(s=this.#f())&&(this.activation===v.MANUAL?s.focus():this.selectTab(s));break;case f.END:(s=this.#y())&&(this.activation===v.MANUAL?s.focus():this.selectTab(s));break;case f.ENTER:case f.SPACE:(s=t.target)&&this.selectTab(s);break;default:return}t.preventDefault()};#a=t=>{let e=t.target.closest("a-tab");e&&this.selectTab(e)};#l=t=>{let e=t.target.closest(".tab-group__scroll-button"),o=this.shadowRoot?.querySelector(".tab-group__tabs");if(!e||!o)return;let i=e.classList.contains("tab-group__scroll-button--start"),s=this.#m()===b.LTR,r=o.scrollLeft;o.scrollTo({left:r+(i?s?-1:1:s?1:-1)*this.scrollDistance})};#d=t=>{let e=t.target,o=this.#v(e);e&&(e.remove(),e.selected&&this.dispatchEvent(new CustomEvent("a-tab-hide",{bubbles:!0,composed:!0,detail:{tabId:e.id}}))),o&&"a-tab-panel"===o.tagName.toLowerCase()&&o.remove()};#s(t){return n(t,this)}selectTabByIndex(t){let e=this.#p()[t];e&&this.selectTab(e)}selectTabById(t){let e=this.#p().find(e=>e.id===t);e&&this.selectTab(e)}selectTab(t){let e=this.#p().find(t=>t.selected);!t||t.disabled||t.selected||"a-tab"!==t.tagName.toLowerCase()||(this.#k(t),window.requestAnimationFrame(()=>{t.scrollIntoView({inline:"nearest",block:"nearest"}),t.focus()}),e&&this.dispatchEvent(new CustomEvent("a-tab-hide",{bubbles:!0,composed:!0,detail:{tabId:e.id}})),this.dispatchEvent(new CustomEvent("a-tab-show",{bubbles:!0,composed:!0,detail:{tabId:t.id}})))}static defineCustomElement(e="a-tab-group"){"u">typeof window&&!window.customElements.get(e)&&window.customElements.define(e,t)}}).defineCustomElement();/*!
...
`,(class t extends HTMLElement{#p=null;#t=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open",delegatesFocus:!0}).appendChild(O.content.cloneNode(!0)),this.shadowRoot&&(this.#p=this.shadowRoot.getElementById("file-input"),this.#t=this.shadowRoot.getElementById("dropzone"))}static get observedAttributes(){return["accept","disabled","multiple"]}attributeChangedCallback(t,e,o){"accept"===t&&e!==o&&this.#p&&(this.#p.accept=this.accept),"disabled"===t&&e!==o&&this.#p&&(this.#p.disabled=this.disabled,this.disabled?(this.#t?.removeAttribute("tabindex"),this.#t?.setAttribute("aria-disabled","true")):(this.#t?.setAttribute("tabindex","0"),this.#t?.setAttribute("aria-disabled","false"))),"multiple"===t&&e!==o&&this.#p&&(this.#p.multiple=this.multiple)}connectedCallback(){this.#s("accept"),this.#s("disabled"),this.#s("maxFiles"),this.#s("maxSize"),this.#s("minSize"),this.#s("multiple"),this.#s("autoFocus"),this.#s("noStyle"),this.#p?.addEventListener("change",this.#i),this.#t?.addEventListener("dragenter",this.#E),this.#t?.addEventListener("dragover",this.#e),this.#t?.addEventListener("dragleave",this.#r),this.#t?.addEventListener("drop",this.#w),this.#t?.addEventListener("click",this.#m),this.#t?.addEventListener("keyup",this.#o),this.autoFocus&&this.#t?.focus()}disconnectedCallback(){this.#p?.removeEventListener("change",this.#i),this.#t?.removeEventListener("dragenter",this.#E),this.#t?.removeEventListener("dragover",this.#e),this.#t?.removeEventListener("dragleave",this.#r),this.#t?.removeEventListener("drop",this.#w),this.#t?.removeEventListener("click",this.#m),this.#t?.removeEventListener("keyup",this.#o)}get accept(){return this.getAttribute("accept")||""}set accept(t){this.setAttribute("accept",null!=t?t.toString():t)}get disabled(){return this.hasAttribute("disabled")}set disabled(t){this.toggleAttribute("disabled",!!t)}get maxFiles(){let t=Number(this.getAttribute("max-files"))||0;return t<=0?1/0:Math.floor(Math.abs(t))}set maxFiles(t){this.setAttribute("max-files",null!=t?t.toString():t)}get maxSize(){let t=this.getAttribute("max-size");if(null===t)return 1/0;let e=Number(t);return Number.isNaN(e)?1/0:e}set maxSize(t){this.setAttribute("max-size",null!=t?t.toString():t)}get minSize(){let t=this.getAttribute("min-size");if(null===t)return 0;let e=Number(t);return Number.isNaN(e)?0:e}set minSize(t){this.setAttribute("min-size",null!=t?t.toString():t)}get multiple(){return this.hasAttribute("multiple")}set multiple(t){this.toggleAttribute("multiple",!!t)}get autoFocus(){return this.hasAttribute("auto-focus")}set autoFocus(t){this.toggleAttribute("auto-focus",!!t)}get noStyle(){return this.hasAttribute("no-style")}set noStyle(t){this.toggleAttribute("no-style",!!t)}#i=async t=>{try{this.#h(await M(t))}catch(t){this.dispatchEvent(new CustomEvent(`${q}-error`,{bubbles:!0,composed:!0,detail:{error:t}}))}};#E=()=>{this.disabled||this.dispatchEvent(new Event(`${q}-dragenter`,{bubbles:!0,composed:!0}))};#e=t=>{if(t.preventDefault(),this.disabled){t.dataTransfer.dropEffect="none";return}t.dataTransfer.dropEffect="copy",this.#t&&(this.#t.classList.add("dropzone--dragover"),this.#t.part.add("dropzone--dragover")),this.dispatchEvent(new Event(`${q}-dragover`,{bubbles:!0,composed:!0}))};#r=()=>{this.disabled||(this.#t&&(this.#t.classList.remove("dropzone--dragover"),this.#t.part.remove("dropzone--dragover")),this.dispatchEvent(new Event(`${q}-dragleave`,{bubbles:!0,composed:!0})))};#w=async t=>{if(!this.disabled){t.preventDefault(),this.#t&&(this.#t.classList.remove("dropzone--dragover"),this.#t.part.remove("dropzone--dragover"));try{this.#h(await M(t))}catch(t){this.dispatchEvent(new CustomEvent(`${q}-error`,{bubbles:!0,composed:!0,detail:{error:t}}))}}};#m=()=>{this.disabled||this.#p?.click()};#o=t=>{this.disabled||(" "===t.key||"Enter"===t.key)&&this.#p?.click()};#h(t){if(!Array.isArray(t)||!t.length)return;let e=[],o=[],i=t.length;if(!this.multiple&&i>1)for(let e of t)o.push({file:e,errors:[{code:N,message:"Too many files selected. Only 1 file is allowed."}]});else if(this.multiple&&i>this.maxFiles)for(let e of t)o.push({file:e,errors:[{code:N,message:`Too many files selected. Only ${this.maxFiles} ${this.maxFiles>1?"files are":"file is"} allowed.`}]});else for(let i of t){let t=/*!
...
`,(class t extends HTMLElement{#t=null;#i=null;#w=null;#s=void 0;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(B.content.cloneNode(!0)),this.shadowRoot&&(this.#t=this.shadowRoot.querySelector("dialog"),this.#i=this.shadowRoot.querySelector('slot[name="footer"]'),this.#w=this.shadowRoot.querySelector('slot[name="close"]'))}static get observedAttributes(){return["open","no-header","no-animations","no-close-button","close-label"]}attributeChangedCallback(t,e,o){if(null!==this.#t){if("open"===t&&e!==o&&(this.open?(this.#t.showModal(),this.dispatchEvent(new CustomEvent("me-open",{bubbles:!0,composed:!0,detail:{element:this}})),document.body&&!this.preserveOverflow&&(document.body.style.overflow="hidden")):this.#t.close()),"no-header"===t&&e!==o){let t=this.#t.querySelector(".dialog__header");null!==t&&(t.hidden=this.noHeader)}if("no-animations"===t&&e!==o&&this.#t.classList.toggle("dialog--no-animations",this.noAnimations),"no-close-button"===t&&e!==o){let t=this.#t.querySelector(".dialog__close");null!==t&&(t.hidden=this.noCloseButton)}"close-label"===t&&e!==o&&this.#E()}}connectedCallback(){this.#p("open"),this.#p("staticBackdrop"),this.#p("noHeader"),this.#p("noAnimations"),this.#p("noCloseButton"),this.#p("fullscreen"),this.#p("preserveOverflow"),this.#p("placement"),this.#p("closeLabel"),this.#t?.addEventListener("click",this.#c),this.#t?.addEventListener("close",this.#o),this.#t?.addEventListener("cancel",this.#m),this.#t?.querySelector('form[method="dialog"]')?.addEventListener("submit",this.#h),this.#i?.addEventListener("slotchange",this.#d),this.#w?.addEventListener("slotchange",this.#a)}disconnectedCallback(){this.#s&&clearTimeout(this.#s),this.#t?.addEventListener("click",this.#c),this.#t?.removeEventListener("close",this.#o),this.#t?.removeEventListener("cancel",this.#m),this.#t?.querySelector('form[method="dialog"]')?.removeEventListener("submit",this.#h),this.#i?.removeEventListener("slotchange",this.#d),this.#w?.removeEventListener("slotchange",this.#a)}get open(){return this.hasAttribute("open")}set open(t){this.toggleAttribute("open",!!t)}get staticBackdrop(){return this.hasAttribute("static-backdrop")}set staticBackdrop(t){this.toggleAttribute("static-backdrop",!!t)}get noHeader(){return this.hasAttribute("no-header")}set noHeader(t){this.toggleAttribute("no-header",!!t)}get noAnimations(){return this.hasAttribute("no-animations")}set noAnimations(t){this.toggleAttribute("no-animations",!!t)}get noCloseButton(){return this.hasAttribute("no-close-button")}set noCloseButton(t){this.toggleAttribute("no-close-button",!!t)}get fullscreen(){return this.hasAttribute("fullscreen")}set fullscreen(t){this.toggleAttribute("fullscreen",!!t)}get preserveOverflow(){return this.hasAttribute("preserve-overflow")}set preserveOverflow(t){this.toggleAttribute("preserve-overflow",!!t)}get placement(){return this.getAttribute("placement")||"center"}set placement(t){this.setAttribute("placement",null!=t?t.toString():t)}get closeLabel(){return this.getAttribute("close-label")||"Close"}set closeLabel(t){this.setAttribute("close-label",null!=t?t.toString():t)}#E(){if(null===this.#t)return;let t=this.#t.querySelector(".dialog__close");null!==t&&((this.#w?.assignedElements()||[])?.some(t=>t.textContent?.replace(/\s/g,"")!=="")?t.removeAttribute("aria-label"):t.setAttribute("aria-label",this.closeLabel))}#r(){this.#s||(this.#t?.classList.add("dialog--pulse"),this.#s=setTimeout(()=>{this.#t?.classList.remove("dialog--pulse"),clearTimeout(this.#s),this.#s=void 0},300))}#o=()=>{this.open=!1,this.dispatchEvent(new CustomEvent("me-close",{bubbles:!0,composed:!0,detail:{element:this}})),document.body&&!this.preserveOverflow&&(document.body.style.overflow="")};#m=t=>{let e=this.#e("escape-key");this.dispatchEvent(e),e.defaultPrevented&&(t.preventDefault(),this.noAnimations||this.#r())};#h=t=>{let e=this.#e("close-button");this.dispatchEvent(e),e.defaultPrevented&&(t.preventDefault(),this.noAnimations||this.#r())};#c=t=>{let e=t.target;if(e===t.currentTarget){let t=this.#e("backdrop-click");this.dispatchEvent(t),t.defaultPrevented||this.staticBackdrop?this.noAnimations||this.#r():this.hide()}if(e instanceof HTMLElement&&null!==e.closest("[data-me-close]")){let t=this.#e("external-invoker");this.dispatchEvent(t),t.defaultPrevented?this.noAnimations||this.#r():this.hide()}};#d=()=>{if(null===this.#t)return;let t=this.#t.querySelector(".dialog__footer");if(null===t)return;let e=this.#i?.assignedNodes(),o=!!e&&e.length>0;t.hidden=!o};#a=()=>{this.#E()};#e(t){return new CustomEvent("me-request-close",{bubbles:!0,composed:!0,cancelable:!0,detail:{reason:t,element:this}})}#p(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}show(){this.open||(this.open=!0)}hide(){this.open&&(this.open=!1)}static defineCustomElement(e="modal-element"){"u">typeof window&&!window.customElements.get(e)&&window.customElements.define(e,t)}}).defineCustomElement();const F="No barcode detected",H=["image/jpg","image/jpeg","image/png","image/apng","image/gif","image/webp","image/avif"];function P(t){return new Promise(function(e,o){t.oncomplete=t.onsuccess=function(){return e(t.result)},t.onabort=t.onerror=function(){return o(t.error)}})}function j(){if(!t){var e,o,i,s;e="keyval-store",o="keyval",(i=indexedDB.open(e)).onupgradeneeded=function(){return i.result.createObjectStore(o)},s=P(i),t=function(t,e){return s.then(function(i){return e(i.transaction(o,t).objectStore(o))})}}return t}const V="barcode-scanner/",U="settings",Z="history",W=async t=>{try{return[null,await function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:j();return e("readonly",function(e){return P(e.get(t))})}(t)]}catch(t){return[t,void 0]}},G=async(t,e)=>{try{return await function(t,e){var o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:j();return o("readwrite",function(o){return o.put(e,t),P(o.transaction)})}(t,e),[null]}catch(t){return[t]}},Y=async()=>W(V+U),X=async t=>G(V+U,t),K=async()=>W(V+Z),J=async t=>G(V+Z,t),Q=(t,e=0,o=!1)=>{let i=null;if("function"!=typeof t)throw TypeError("Expected a function for first argument");return(...s)=>{clearTimeout(i),o&&!i&&t(...s),i=setTimeout(()=>{i=null,o||t(...s)},e)}},tt=()=>"function"==typeof HTMLDialogElement;function te(t){let e=document.getElementById("historyList");if(!e)return;let o=document.getElementById("emptyHistoryBtn");e.replaceChildren(),Array.isArray(t)&&0!==t.length?(o.hidden=!1,t.forEach((t,o)=>{let i;let s=document.createElement("li");s.setAttribute("data-value",t);try{new URL(t),(i=document.createElement("a")).href=t,i.setAttribute("target","_blank"),i.setAttribute("rel","noreferrer noopener")}catch{i=document.createElement("span")}i.textContent=t,i.setAttribute("id",`historyItem-${o}`);let r=document.createElement("div");r.className="history-modal__actions";let a=document.createElement("custom-clipboard-copy");a.setAttribute("id",`copyHistoryItem-${o}`),a.setAttribute("aria-label","Copy to clipboard"),a.setAttribute("aria-labelledby",`copyHistoryItem-${o} historyItem-${o}`),a.setAttribute("only-icon",""),a.setAttribute("value",t),r.appendChild(a);let n=document.createElement("button");n.type="button",n.className="history-modal__delete-action",n.setAttribute("data-action","delete"),n.setAttribute("id",`removeHistoryItem-${o}`),n.setAttribute("aria-label","Remove from history"),n.setAttribute("aria-labelledby",`removeHistoryItem-${o} historyItem-${o}`),n.innerHTML=`
        ...
        `,r.appendChild(n),s.appendChild(i),s.appendChild(r),e.appendChild(s)})):(e.innerHTML="<li>There are no saved items in history.</li>",o.hidden=!0)}async function to(t){let[,e]=await Y();if(!t||!e?.addToHistory)return;let[o,i=[]]=await K();if(!o&&Array.isArray(i)&&!i.find(e=>e===t)){let e=[...i,t],[o]=await J(e);o||te(e)}}async function ti(t){if(!t)return;let[e,o=[]]=await K();if(!e&&Array.isArray(o)){let e=o.filter(e=>e!==t),[i]=await J(e);i||te(e)}}async function ts(){let[t]=await J([]);t||te([])}async function tr(t,e){if(!t||!e)return;let o=t.querySelector("scan-result");if(o)o.setAttribute("value",e);else{let o=document.createElement("scan-result");o.setAttribute("value",e),o.setAttribute("role","alert"),o.setAttribute("aria-live","assertive"),o.setAttribute("aria-atomic","true"),t.appendChild(o)}}const ta=(()=>{let t=new(window.AudioContext||window.webkitAudioContext||window.audioContext);if(t)return e=>{let{duration:o,frequency:i,volume:s,type:r,onEnded:a}=e,n=t.createOscillator(),l=t.createGain();n.connect(l),l.connect(t.destination),s&&(l.gain.value=s),i&&(n.frequency.value=i),r&&(n.type=r),"function"==typeof a&&(n.onended=a),n.start(t.currentTime),n.stop(t.currentTime+(o||500)/1e3)}})();async function tn(t=0){if("function"==typeof window.navigator.vibrate)try{window.navigator.vibrate(t)}catch{}}async function tl(t={}){let{success:e=!0}=t,[,o]=await Y();o&&(o.beep&&ta(e?{duration:200,frequency:860,volume:.03,type:"square"}:{duration:300,frequency:200,volume:.05,type:"sawtooth"}),o.vibrate&&tn(e?100:200))}function td(t,e){if(!t||!e)return;let o=t.getBoundingClientRect();e.style.cssText=`width: ${o.width}px; height: ${o.height}px`}class tc{static async polyfill(){if(!("BarcodeDetector"in window))try{await s("cw9o9")}catch{throw Error("BarcodeDetector API is not supported by your browser.")}}static async getSupportedFormats(){return await window.BarcodeDetector.getSupportedFormats()}static async create(){return new tc(await window.BarcodeDetector.getSupportedFormats())}static async init(){try{await tc.polyfill();let t=await tc.create(),e=await tc.getSupportedFormats();return{barcodeReader:t,barcodeFormats:e,barcodeReaderError:null}}catch(t){return{barcodeReader:null,barcodeFormats:[],barcodeReaderError:t}}}constructor(t){this.barcodeReader=new window.BarcodeDetector({formats:t})}async detect(t){if(!this.barcodeReader)throw Error("BarcodeReader is not initialized.");let e=await this.barcodeReader.detect(t);if(Array.isArray(e)&&e.length>0)return e[0];throw Error("Could not detect barcode from provided source.")}}async function th(t){let[,e={}]=await Y();Object.entries(e).forEach(([e,o])=>{let i=t.querySelector(`[name="${e}"]`);i&&(i.checked=o)})}function tu(t={}){let{el:e,isTorchOn:o}={el:document.getElementById("torchButton"),isTorchOn:!1,...t},i=e.querySelectorAll("svg path");2===i.length&&(i[0].style.display=o?"none":"block",i[1].style.display=o?"block":"none",e.setAttribute("title",`Turn ${o?"off":"on"} flash`))}const tm=(t,e,o)=>(Number.isNaN(e)&&(e=0),Number.isNaN(o)&&(o=0),Math.min(Math.max(t,Math.min(e,o)),Math.max(e,o))),tp="video-capture",tb=`
 ...
 * @author George Raptis <georapbox@gmail.com>
 * @license MIT
 */var tf="clipboard-copy",ty="success",tw="error",tE=document.createElement("template"),tA=`
  :host([hidden]),
  [hidden],
  ::slotted([hidden]) {
    display: none !important;
...
`;var tx=class t extends HTMLElement{#t=void 0;#p=null;#e=null;#i=null;#s=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tE.content.cloneNode(!0)),this.shadowRoot&&(this.#p=this.shadowRoot.querySelector("button"),this.#e=this.shadowRoot.querySelector('slot[name="copy"]'),this.#i=this.shadowRoot.querySelector('slot[name="success"]'),this.#s=this.shadowRoot.querySelector('slot[name="error"]'))}static get observedAttributes(){return["disabled"]}attributeChangedCallback(t,e,o){"disabled"===t&&e!==o&&this.#p&&(this.#p.disabled=this.disabled,this.#p.setAttribute("aria-disabled",this.disabled.toString()),this.#p.part.contains("button")&&this.#p.part.toggle("button--disabled",this.disabled))}connectedCallback(){this.#r("value"),this.#r("from"),this.#r("disabled"),this.#r("feedbackDuration"),this.#p?.addEventListener("click",this.#E)}disconnectedCallback(){this.#p?.removeEventListener("click",this.#E),this.#w()}get value(){return this.getAttribute("value")||""}set value(t){this.setAttribute("value",null!=t?t.toString():t)}get from(){return this.getAttribute("from")||""}set from(t){this.setAttribute("from",null!=t?t.toString():t)}get disabled(){return this.hasAttribute("disabled")}set disabled(t){this.toggleAttribute("disabled",!!t)}get feedbackDuration(){return Number(this.getAttribute("feedback-duration"))||1e3}set feedbackDuration(t){this.setAttribute("feedback-duration",null!=t?t.toString():t)}async #m(){if(!(!this.value&&!this.from))try{let t="";if(this.value)t=this.value;else if(this.from){let e="getRootNode"in Element.prototype?this.#p?.getRootNode({composed:!0}):this.#p?.ownerDocument;if(!e||!(e instanceof Document||e instanceof ShadowRoot))return;let o=e.querySelector(this.from);if(!o)return;o instanceof HTMLInputElement||o instanceof HTMLTextAreaElement?t=o.value:o instanceof HTMLAnchorElement&&o.hasAttribute("href")?t=o.href:t=o.textContent||""}await navigator.clipboard.writeText(t),this.#c(ty),this.dispatchEvent(new CustomEvent(`${tf}-success`,{bubbles:!0,composed:!0,detail:{value:t}}))}catch(t){this.#c(tw),this.dispatchEvent(new CustomEvent(`${tf}-error`,{bubbles:!0,composed:!0,detail:{error:t}}))}}#E=t=>{t.preventDefault(),this.disabled||this.#t||this.#m()};#c(t){this.#e&&(this.#e.hidden=!0),this.#i&&(this.#i.hidden=t!==ty),this.#s&&(this.#s.hidden=t!==tw),this.#p?.part.remove("button--success"),this.#p?.part.remove("button--error"),this.#p?.part.add(`button--${t}`),this.#t&&clearTimeout(this.#t),this.#t=setTimeout(()=>{this.#e&&(this.#e.hidden=!1),this.#i&&(this.#i.hidden=!0),this.#s&&(this.#s.hidden=!0),this.#p?.part.remove(`button--${t}`),this.#t=void 0},this.feedbackDuration)}#w(){this.#t&&clearTimeout(this.#t),this.#t=void 0,this.#e&&(this.#e.hidden=!1),this.#i&&(this.#i.hidden=!0),this.#s&&(this.#s.hidden=!0),this.#p?.part.remove("button--success"),this.#p?.part.remove("button--error")}#r(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(e=tf){"u">typeof window&&!window.customElements.get(e)&&window.customElements.define(e,t)}};class tk extends tx{constructor(){super();let t=this.shadowRoot.querySelector('slot[name="copy"]'),e=this.shadowRoot.querySelector('slot[name="success"]');t.innerHTML=`
 ...
 * @author George Raptis <georapbox@gmail.com>
 * @license MIT
 */function tC(t){return null!==t&&"object"==typeof t?"share"in navigator&&"canShare"in navigator&&navigator.canShare(t):"share"in navigator}tk.defineCustomElement();const tS=`
  :host {
    box-sizing: border-box;
  }
...
`;class tL extends HTMLElement{constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tz.content.cloneNode(!0))}get value(){return this.getAttribute("value")}set value(t){this.setAttribute("value",t)}static get observedAttributes(){return["value"]}attributeChangedCallback(t,e,o){"value"===t&&e!==o&&this.#R(this.value)}connectedCallback(){if(this.#T("value"),!tC()){let t=this.shadowRoot.querySelector("web-share");t&&(t.hidden=!0)}}async #R(t){let e;let o=this.shadowRoot.querySelector(".result"),i=o?.querySelector(".result__actions"),s=o?.querySelector(".result__item");s&&s.remove();try{let[,o]=await Y();new URL(t),(e=document.createElement("a")).href=t,window.requestAnimationFrame(()=>e.focus()),o?.openWebPageSameTab||(e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")),o?.openWebPage&&e.click()}catch{e=document.createElement("span")}e.className="result__item",e.classList.toggle("result__item--no-barcode",t===F),e.textContent=t,o?.insertBefore(e,i);let r=t!==F,a=o?.querySelector("custom-clipboard-copy"),n=o?.querySelector("web-share");a&&r?(a.setAttribute("value",t),a.hidden=!1):(a.hidden=!0,a.removeAttribute("value")),n&&tC()&&r?(n.setAttribute("share-text",t),n.hidden=!1):(n.hidden=!0,n.removeAttribute("share-text"))}#T(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="scan-result"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tL)}}tL.defineCustomElement(),async function(){let t;let e=new URLSearchParams(window.location.search).has("experimental"),o=document.querySelector("a-tab-group"),i=document.querySelector("video-capture"),s=document.getElementById("cameraPanel"),r=document.getElementById("filePanel"),a=document.getElementById("scanInstructions"),n=document.getElementById("scanBtn"),l=document.getElementById("dropzone"),d=document.querySelector("resize-observer"),c=document.getElementById("scanFrame"),h=document.getElementById("facingModeButton"),u=document.getElementById("torchButton"),m=document.getElementById("globalActions"),p=document.getElementById("historyBtn"),b=document.getElementById("historyDialog"),g=document.getElementById("settingsBtn"),v=document.getElementById("settingsDialog"),f=document.forms["settings-form"],y=document.getElementById("cameraSelect"),w=!0;tt()&&(m.hidden=!1,b.hidden=!1,v.hidden=!1);let{barcodeReader:E,barcodeFormats:A,barcodeReaderError:x}=await tc.init();if(x){let t=document.getElementById("barcodeReaderError");w=!1,m.hidden=!0,o.hidden=!0,t.hidden=!1,t.textContent=x?.message;return}i.addEventListener("video-capture:video-play",S,{once:!0}),i.addEventListener("video-capture:error",function(t){let e=t.detail.error;if("NotFoundError"===e.name)return;let o="NotAllowedError"===e.name?"Permission to use webcam was denied or video Autoplay is disabled. Reload the page to give appropriate permissions to webcam.":e.message;s.innerHTML=`<div class="alert alert-danger" role="alert" style="margin: 0;">${o}</div>`},{once:!0}),tv.defineCustomElement();let k=i?.shadowRoot?.querySelector("video");async function C(){a.hidden=!1;try{let e=await E.detect(k),o=e?.rawValue??"";if(!o)throw Error(F);window.cancelAnimationFrame(t),tr(s,o),to(o),a.hidden=!0,n.hidden=!1,c.hidden=!0,y.disabled=!0,tl();return}catch{}w&&(t=window.requestAnimationFrame(()=>C()))}async function S(t){c.hidden=!1,td(t.detail.video,c),C();let o=t.target.getTrackSettings(),s=t.target.getTrackCapabilities(),r=document.getElementById("zoomLevel");if("facingMode"in o&&(h.hidden=!1),s?.torch&&(u.hidden=!1,i.hasAttribute("torch")&&tu({el:u,isTorchOn:!0})),o?.zoom&&s?.zoom){let t=document.getElementById("zoomControls"),e=s?.zoom?.min||0,a=s?.zoom?.max||10,n=o?.zoom||1;t.hidden=!1,r.textContent=n,t.addEventListener("click",t=>{let o=t.target.closest('[data-action="zoom-in"]'),s=t.target.closest('[data-action="zoom-out"]');o&&n<a&&(n+=.5),s&&n>e&&(n-=.5),r.textContent=n,i.zoom=n})}if(e){let t=await tv.getVideoInputDevices();t.forEach((t,e)=>{let o=document.createElement("option");o.value=t.deviceId,o.textContent=t.label||`Camera ${e+1}`,y.appendChild(o)}),t.length>1&&(y.hidden=!1)}}l.accept=H.join(","),th(f),function(t){if(!Array.isArray(t)||0===t.length)return;let e=document.getElementById("supportedFormats");e&&(e.textContent=`Supported formats: ${t.join(", ")}`)}(A),te((await K())[1]||[]),n.addEventListener("click",function(){n.hidden=!0,c.hidden=!1,y.disabled=!1,function(t){if(!t)return;let e=t.querySelector("scan-result");e?.remove()}(s),C()}),o.addEventListener("a-tab-show",Q(function(t){let e=t.detail.tabId,o=document.querySelector("video-capture");if("cameraTab"===e){if(w=!0,!o)return;o.loading||s.querySelector("scan-result")||C(),"function"==typeof o.startVideoStream&&o.startVideoStream()}else"fileTab"===e&&(w=!1,null!=o&&"function"==typeof o.stopVideoStream&&o.stopVideoStream())},250)),l.addEventListener("files-dropzone-drop",function(t){!function(t){if(!t)return;let e=new Image,o=new FileReader;o.onload=o=>{let i=o.target.result;e.onload=async()=>{try{let t=await E.detect(e),o=t?.rawValue??"";if(!o)throw Error(F);tr(r,o),to(o),tl()}catch(t){tr(r,F),tl({success:!1})}},e.src=i,e.alt="Image preview",l.replaceChildren();let s=document.createElement("div");s.className="dropzone-preview",s.setAttribute("aria-hidden","true");let a=document.createElement("div");a.className="dropzone-preview__image-wrapper";let n=document.createElement("div");n.className="dropzone-preview__file-name",n.textContent=t.name,a.appendChild(e),s.appendChild(a),s.appendChild(n),l.prepend(s)},o.readAsDataURL(t)}(t.detail.acceptedFiles[0])}),d.addEventListener("resize-observer:resize",function(){td(i.shadowRoot.querySelector("video"),c)}),g.addEventListener("click",function(){v.open=!0}),f.addEventListener("change",function(t){let e={};t.currentTarget.querySelectorAll('input[type="checkbox"]').forEach(t=>e[t.name]=t.checked),X(e)}),p.addEventListener("click",function(){b.open=!0}),b.addEventListener("click",function(t){let e=t.target;if(e.closest('[data-action="delete"]')){let t=e.closest("li").dataset.value;if(window.confirm(`Delete history item ${t}?`)){ti(t);return}}if(e.closest("#emptyHistoryBtn")&&window.confirm("Empty history? This action cannot be undone.")){ts();return}}),h.addEventListener("click",function(){let t="user"===i.facingMode?"environment":"user";i.facingMode=t,"function"==typeof i.restartVideoStream&&i.restartVideoStream(y?.value||void 0)}),u.addEventListener("click",function(t){i.torch=!i.torch,tu({el:t.currentTarget,isTorchOn:i.hasAttribute("torch")})}),e&&y.addEventListener("change",function(t){let e=t.target.value||void 0;"function"==typeof i.restartVideoStream&&i.restartVideoStream(e)}),document.addEventListener("visibilitychange",function(){if("cameraTab"===o.querySelector("[selected]").getAttribute("id")){if("hidden"===document.visibilityState)w=!1,null!=i&&"function"==typeof i.stopVideoStream&&i.stopVideoStream();else{w=!0;let t=document.querySelector("video-capture");if(!t)return;t.loading||s.querySelector("scan-result")||C(),"function"==typeof t.startVideoStream&&t.startVideoStream()}}}),document.addEventListener("keydown",function(t){"Escape"===t.key&&function(){let t=o.querySelector("#cameraTab").hasAttribute("selected"),e=!n.hidden,i=v.hasAttribute("open"),s=b.hasAttribute("open");e&&t&&!(i||s)&&n.click()}()})}();
//# sourceMappingURL=index.62e45fd0.js.map
