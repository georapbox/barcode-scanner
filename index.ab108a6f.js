var t,e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},o={},i={},r=e.parcelRequirea202;null==r&&((r=function(t){if(t in o)return o[t].exports;if(t in i){var e=i[t];delete i[t];var r={id:t,exports:{}};return o[t]=r,e.call(r.exports,r,r.exports),r.exports}var s=Error("Cannot find module '"+t+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(t,e){i[t]=e},e.parcelRequirea202=r);var s=r.register;s("cw9o9",function(t,e){var o=r("hffE7");t.exports=o("6z40I").then(()=>r("aexh3"))}),s("hffE7",function(t,e){t.exports=function(t){return import(r("kyEFX").resolve(t))}});/*!
...
`;class tT extends HTMLElement{constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tz.content.cloneNode(!0))}get value(){return this.getAttribute("value")}set value(t){this.setAttribute("value",t)}static get observedAttributes(){return["value"]}attributeChangedCallback(t,e,o){"value"===t&&e!==o&&this.#R(this.value)}connectedCallback(){if(this.#L("value"),!tC()){let t=this.shadowRoot.querySelector("web-share");t&&(t.hidden=!0)}}async #R(t){let e;let o=this.shadowRoot.querySelector(".result"),i=o?.querySelector(".result__actions"),r=o?.querySelector(".result__item");r&&r.remove();try{let[,o]=await Y();new URL(t),(e=document.createElement("a")).href=t,window.requestAnimationFrame(()=>e.focus()),o?.openWebPageSameTab||(e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")),o?.openWebPage&&e.click()}catch{e=document.createElement("span")}e.className="result__item",e.classList.toggle("result__item--no-barcode",t===F),e.textContent=t,o?.insertBefore(e,i);let s=t!==F,a=o?.querySelector("custom-clipboard-copy"),n=o?.querySelector("web-share");a&&s?(a.setAttribute("value",t),a.hidden=!1):(a.hidden=!0,a.removeAttribute("value")),n&&tC()&&s?(n.setAttribute("share-text",t),n.hidden=!1):(n.hidden=!0,n.removeAttribute("share-text"))}#L(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="scan-result"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tT)}}tT.defineCustomElement(),async function(){let t;let e=new URLSearchParams(window.location.search).has("experimental"),o=document.querySelector("a-tab-group"),i=document.querySelector("video-capture"),r=document.getElementById("cameraPanel"),s=document.getElementById("filePanel"),a=document.getElementById("scanInstructions"),n=document.getElementById("scanBtn"),l=document.getElementById("dropzone"),d=document.querySelector("resize-observer"),c=document.getElementById("scanFrame"),h=document.getElementById("torchButton"),u=document.getElementById("globalActions"),m=document.getElementById("historyBtn"),p=document.getElementById("historyDialog"),b=document.getElementById("settingsBtn"),g=document.getElementById("settingsDialog"),v=document.forms["settings-form"],f=document.getElementById("cameraSelect"),y=!0;tt()&&(u?.removeAttribute("hidden"),p?.removeAttribute("hidden"),g?.removeAttribute("hidden"));let{barcodeReader:w,barcodeFormats:E,barcodeReaderError:A}=await tc.init();if(A){let t=document.getElementById("barcodeReaderError");y=!1,u?.setAttribute("hidden",""),o?.setAttribute("hidden",""),t?.removeAttribute("hidden"),t.textContent=A?.message;return}i.addEventListener("video-capture:video-play",z,{once:!0}),i.addEventListener("video-capture:error",function(t){let e=t.detail.error;if("NotFoundError"===e.name)return;let o="NotAllowedError"===e.name?"Permission to use webcam was denied or video Autoplay is disabled. Reload the page to give appropriate permissions to webcam.":e.message;r.innerHTML=`<div class="alert alert-danger" role="alert" style="margin: 0;">${o}</div>`},{once:!0}),tv.defineCustomElement();let x=i?.shadowRoot,k=x?.querySelector("video"),C=x?.querySelector('[part="actions-container"]');async function S(){a?.removeAttribute("hidden");try{let e=await w.detect(k),o=e?.rawValue??"";if(!o)throw Error(F);window.cancelAnimationFrame(t),ts(r,o),to(o),a?.setAttribute("hidden",""),n?.removeAttribute("hidden"),c?.setAttribute("hidden",""),C?.setAttribute("hidden",""),tl();return}catch{}y&&(t=window.requestAnimationFrame(()=>S()))}async function z(t){c?.removeAttribute("hidden"),td(t.detail.video,c),S();let o=t.target.getTrackSettings(),r=t.target.getTrackCapabilities(),s=document.getElementById("zoomLevel");if(r?.torch&&(h?.removeAttribute("hidden"),i.hasAttribute("torch")&&tu({el:h,isTorchOn:!0})),o?.zoom&&r?.zoom){let t=document.getElementById("zoomControls"),e=r?.zoom?.min||0,a=r?.zoom?.max||10,n=o?.zoom||1;t?.removeAttribute("hidden"),s.textContent=n,t.addEventListener("click",t=>{let o=t.target.closest('[data-action="zoom-in"]'),r=t.target.closest('[data-action="zoom-out"]');o&&n<a&&(n+=.5),r&&n>e&&(n-=.5),s.textContent=n,i.zoom=n})}if(e){let t=await tv.getVideoInputDevices();t.forEach((t,e)=>{let o=document.createElement("option");o.value=t.deviceId,o.textContent=t.label||`Camera ${e+1}`,f.appendChild(o)}),t.length>1&&f?.removeAttribute("hidden")}}l.accept=H.join(","),th(v),function(t){if(!Array.isArray(t)||0===t.length)return;let e=document.getElementById("supportedFormats");e&&(e.textContent=`Supported formats: ${t.join(", ")}`)}(E),te((await K())[1]||[]),n.addEventListener("click",function(){n?.setAttribute("hidden",""),c?.removeAttribute("hidden"),C?.removeAttribute("hidden"),function(t){if(!t)return;let e=t.querySelector("scan-result");e?.remove()}(r),S()}),o.addEventListener("a-tab-show",Q(function(t){let e=t.detail.tabId,o=document.querySelector("video-capture");if("cameraTab"===e){if(y=!0,!o)return;let t=null!=r.querySelector("scan-result");if(o.loading||t||(c?.removeAttribute("hidden"),C?.removeAttribute("hidden"),S()),"function"==typeof o.startVideoStream){let t=f?.value||void 0;o.startVideoStream(t)}}else"fileTab"===e&&(y=!1,null!=o&&"function"==typeof o.stopVideoStream&&o.stopVideoStream(),c?.setAttribute("hidden",""),C?.setAttribute("hidden",""))},250)),l.addEventListener("files-dropzone-drop",function(t){!function(t){if(!t)return;let e=new Image,o=new FileReader;o.onload=o=>{let i=o.target.result;e.onload=async()=>{try{let t=await w.detect(e),o=t?.rawValue??"";if(!o)throw Error(F);ts(s,o),to(o),tl()}catch(t){ts(s,F),tl({success:!1})}},e.src=i,e.alt="Image preview",l.replaceChildren();let r=document.createElement("div");r.className="dropzone-preview",r.setAttribute("aria-hidden","true");let a=document.createElement("div");a.className="dropzone-preview__image-wrapper";let n=document.createElement("div");n.className="dropzone-preview__file-name",n.textContent=t.name,a.appendChild(e),r.appendChild(a),r.appendChild(n),l.prepend(r)},o.readAsDataURL(t)}(t.detail.acceptedFiles[0])}),d.addEventListener("resize-observer:resize",function(){td(i.shadowRoot.querySelector("video"),c)}),b.addEventListener("click",function(){g.open=!0}),v.addEventListener("change",function(t){let e={};t.currentTarget.querySelectorAll('input[type="checkbox"]').forEach(t=>e[t.name]=t.checked),X(e)}),m.addEventListener("click",function(){p.open=!0}),p.addEventListener("click",function(t){let e=t.target;if(e.closest('[data-action="delete"]')){let t=e.closest("li").dataset.value;if(window.confirm(`Delete history item ${t}?`)){ti(t);return}}if(e.closest("#emptyHistoryBtn")&&window.confirm("Empty history? This action cannot be undone.")){tr();return}}),h.addEventListener("click",function(t){i.torch=!i.torch,tu({el:t.currentTarget,isTorchOn:i.hasAttribute("torch")})}),e&&f.addEventListener("change",function(t){if("function"!=typeof i.restartVideoStream)return;let e=t.target.value||void 0;i.restartVideoStream(e)}),document.addEventListener("visibilitychange",function(){if("cameraTab"===o.querySelector("[selected]").getAttribute("id")){if("hidden"===document.visibilityState)y=!1,null!=i&&"function"==typeof i.stopVideoStream&&i.stopVideoStream();else{y=!0;let t=document.querySelector("video-capture");if(!t)return;if(t.loading||r.querySelector("scan-result")||S(),"function"==typeof t.startVideoStream){let e=f?.value||void 0;t.startVideoStream(e)}}}}),document.addEventListener("keydown",function(t){"Escape"===t.key&&function(){let t=o.querySelector("#cameraTab").hasAttribute("selected"),e=!n.hidden,i=g.hasAttribute("open"),r=p.hasAttribute("open");e&&t&&!(i||r)&&n.click()}()})}();
//# sourceMappingURL=index.ab108a6f.js.map
